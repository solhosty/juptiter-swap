...
import { Beet, FixableBeet, FixedSizeBeet, SupportedTypeDefinition } from '@metaplex-foundation/beet/dist/types/src/types';
/**
 ...
 */
export declare type CompositesExports = keyof typeof import('@metaplex-foundation/beet/dist/types/src/beets/composites');
/**
 * @category TypeDefinition
 */
