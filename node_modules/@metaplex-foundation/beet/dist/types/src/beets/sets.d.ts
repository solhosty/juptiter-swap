import { Beet, FixableBeet, SupportedTypeDefinition } from '@metaplex-foundation/beet/dist/types/src/types';
/**
 ...
 */
export declare type SetsExports = keyof Omit<typeof import('@metaplex-foundation/beet/dist/types/src/beets/sets'), 'setsTypeSet'>;
/**
 * @category TypeDefinition
 */
