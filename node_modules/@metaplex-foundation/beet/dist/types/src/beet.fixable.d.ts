...
import { Beet, FixedSizeBeet } from '@metaplex-foundation/beet/dist/types/src/types';
/**
 ...
 * @category beet
 */
export declare function fixBeetFromData<T, V = Partial<T>>(beet: Beet<T, V>, buf: Buffer, offset: number): FixedSizeBeet<T, V>;
/**
 * Converts the provided beet into a {@link FixedBeet} unless it already is.
 ...
 * @category beet
 */
export declare function fixBeetFromValue<T, V = Partial<T>>(beet: Beet<T, V>, val: V): FixedSizeBeet<T, V>;
