...
async function debugUser(client, group, mangoAccount) {
  ...
  console.log(
    "HealthCache.fromMangoAccount(group,mangoAccount).health(HealthType.init) " + toUiDecimalsForQuote(
      HealthCache.fromMangoAccount(group, mangoAccount).health(HealthType.init).toNumber()
    )
  );
  console.log(
  ...
  console.log(
    "mangoAccount.getHealthRatio(HealthType.maint) " + mangoAccount.getHealthRatio(group, HealthType.maint).toNumber()
  );
  console.log(
  ...
  console.log(
    "mangoAccount.getAssetsValue() " + toUiDecimalsForQuote(
      mangoAccount.getAssetsValue(group, HealthType.init).toNumber()
    )
  );
  console.log(
    "mangoAccount.getLiabsValue() " + toUiDecimalsForQuote(
...
async function main() {
  ...
  for (const keypair of [USER_KEYPAIR]) {
    ...
    for (const mangoAccount of mangoAccounts) {
      if (!MANGO_ACCOUNT_PK || mangoAccount.publicKey.equals(new PublicKey(MANGO_ACCOUNT_PK))) {
        console.log();
...
//# sourceMappingURL=debug-user.mjs.map