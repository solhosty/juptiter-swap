...
var Id = class {
  ...
  getBanks() {
    return Array.from(
      this.banks.filter((perpMarket) => perpMarket.active).map((bank) => new PublicKey(bank.publicKey))
    );
  }
  getStubOracles() {
    return Array.from(
  ...
  getSerum3Markets() {
    return Array.from(
      this.serum3Markets.filter((perpMarket) => perpMarket.active).map((serum3Market) => new PublicKey(serum3Market.publicKey))
    );
  }
  getPerpMarkets() {
    return Array.from(
      this.perpMarkets.filter((perpMarket) => perpMarket.active).map((perpMarket) => new PublicKey(perpMarket.publicKey))
    );
  }
...
//# sourceMappingURL=chunk-FP7S2XO3.mjs.map