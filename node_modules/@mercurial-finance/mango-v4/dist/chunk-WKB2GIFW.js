"use strict";Object.defineProperty(exports, "__esModule", {value: true});// ts/client/src/clientIxParamBuilder.ts
...
function buildIxGate(p) {
  const ixGate = new (0, _anchor.BN)(0);
  function toggleIx(ixGate2, p2, propName, index) {
    if (p2[propName] === void 0) {
      throw new Error(`Unknown property ${propName}`);
    }
    ixGate2.ior(p2[propName] ? new (0, _anchor.BN)(0) : new (0, _anchor.BN)(1).ushln(index));
  }
...
exports.NullTokenEditParams = NullTokenEditParams; exports.NullPerpEditParams = NullPerpEditParams; exports.TrueIxGateParams = TrueIxGateParams; exports.buildIxGate = buildIxGate;
//# sourceMappingURL=chunk-WKB2GIFW.js.map