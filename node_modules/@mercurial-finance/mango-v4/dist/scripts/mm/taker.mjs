...
async function takeOrder(client, group, mangoAccount, perpMarket, side) {
  ...
  const price = side === PerpOrderSide.bid ? perpMarket.uiPrice * 1.01 : perpMarket.uiPrice * 0.99;
  console.log(
    `- ${perpMarket.name} taking with a ${side === PerpOrderSide.bid ? "bid" : "ask"} at  price ${price.toFixed(4)} and size ${size.toFixed(6)}`
  );
...
main();
//# sourceMappingURL=taker.mjs.map