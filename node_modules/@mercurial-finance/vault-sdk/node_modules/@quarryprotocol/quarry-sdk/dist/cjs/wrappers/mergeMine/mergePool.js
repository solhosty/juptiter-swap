...
class MergePool {
    ...
    deposit({ amount, rewarder, mmOwner = this.provider.wallet.publicKey, }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const [mmKey] = yield (0, pda_2.findMergeMinerAddress)({
                pool: this.key,
                owner: mmOwner,
            });
            const mmAccount = yield this.provider.getAccountInfo(mmKey);
            const { address: mmPrimaryTokenAccount, instruction: mmATAIx } = yield (0, token_utils_1.getOrCreateATA)({
                provider: this.provider,
                mint: poolData.primaryMint,
                owner: mmKey,
            });
            ...
            allInstructions.push(token_utils_1.SPLToken.createTransferInstruction(token_utils_1.TOKEN_PROGRAM_ID, ata, mmPrimaryTokenAccount, mmOwner, [], amount.toU64()));
            return new solana_contrib_1.TransactionEnvelope(this.provider, allInstructions).combine(yield this.stakePrimaryMiner(rewarder, mmKey));
        });
    }
    /**
    ...
    stakeReplicaMiner(rewarder, mergeMiner) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const [quarry] = yield (0, pda_1.findQuarryAddress)(rewarder, poolData.replicaMint);
            const [miner] = yield (0, pda_1.findMinerAddress)(quarry, mergeMiner);
            ...
            if (!(yield this.provider.getAccountInfo(miner))) {
                ...
                txEnv.instructions.unshift(this.program.instruction.initMinerV2({
                    accounts: {
                        ...
                        payer: this.provider.wallet.publicKey,
                        mineProgram: constants_1.QUARRY_ADDRESSES.Mine,
                        systemProgram: web3_js_1.SystemProgram.programId,
    ...
    claimRewardsCommon(quarryMint, stake, mmOwner = this.provider.wallet.publicKey) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const [minter] = yield (0, __1.findMinterAddress)(rewarder.mintWrapper, stake.rewarder, this.mergeMine.sdk.programs.MintWrapper.programId);
    ...
    getPrimaryStakeAccounts(rewarder, mergeMiner) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const poolData = yield this.data();
            const [quarry] = yield (0, pda_1.findQuarryAddress)(rewarder, poolData.primaryMint);
            const [miner] = yield (0, pda_1.findMinerAddress)(quarry, mergeMiner);
            const minerVault = yield (0, token_utils_1.getATAAddress)({
                mint: poolData.primaryMint,
                owner: miner,
