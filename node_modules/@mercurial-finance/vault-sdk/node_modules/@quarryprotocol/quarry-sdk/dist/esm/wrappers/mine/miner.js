...
export class MinerWrapper {
    ...
    claimV1() {
        return __awaiter(this, void 0, void 0, function* () {
            const instructions = [];
            const { address: rewardsTokenAccount, instruction: ataInstruction } = yield getOrCreateATA({
                provider: this.provider,
            ...
            const [minter] = yield findMinterAddress(this.quarry.rewarderData.mintWrapper, this.quarry.quarryData.rewarder, this.sdk.mintWrapper.program.programId);
