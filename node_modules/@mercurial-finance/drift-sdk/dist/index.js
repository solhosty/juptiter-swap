...
var _anchor = require('@project-serum/anchor'); var anchor = _interopRequireWildcard(_anchor); var anchor2 = _interopRequireWildcard(_anchor); var anchor4 = _interopRequireWildcard(_anchor); var anchor3 = _interopRequireWildcard(_anchor);
var _web3js = require('@solana/web3.js');
var _client = require('@pythnetwork/client'); var _client2 = _interopRequireDefault(_client);
...
var TokenFaucet = class {
  constructor(connection, wallet, programId, mint, opts) {
    ...
    this.wallet = wallet;
    this.opts = opts || _anchor.AnchorProvider.defaultOptions();
    const provider = new (0, _anchor.AnchorProvider)(connection, wallet, this.opts);
    this.provider = provider;
    this.program = new (0, _anchor.Program)(token_faucet_default, programId, provider);
    this.mint = mint;
  }
  ...
  async mintToUser(userTokenAccount, amount) {
    ...
    const tx = new (0, _web3js.Transaction)().add(mintIx);
  ...
  async createAssociatedTokenAccountAndMintToInstructions(userPublicKey, amount) {
    ...
    const createAssociatedAccountIx = _spltoken.Token.createAssociatedTokenAccountInstruction(
  ...
  async getAssosciatedMockUSDMintAddress(props) {
    const state = await this.fetchState();
    return _spltoken.Token.getAssociatedTokenAddress(
      _spltoken.ASSOCIATED_TOKEN_PROGRAM_ID,
      _spltoken.TOKEN_PROGRAM_ID,
      state.mint,
      props.userPubKey
  ...
  async getTokenAccountInfo(props) {
    ...
    const state = await this.fetchState();
    const token = new (0, _spltoken.Token)(
      this.connection,
      state.mint,
      _spltoken.TOKEN_PROGRAM_ID,
      this.provider.payer
...
var ZERO = new (0, _anchor.BN)(0);
var ONE = new (0, _anchor.BN)(1);
var TWO = new (0, _anchor.BN)(2);
var THREE = new (0, _anchor.BN)(3);
var FOUR = new (0, _anchor.BN)(4);
var FIVE = new (0, _anchor.BN)(5);
var SIX = new (0, _anchor.BN)(6);
var SEVEN = new (0, _anchor.BN)(7);
var EIGHT = new (0, _anchor.BN)(8);
var NINE = new (0, _anchor.BN)(9);
var TEN = new (0, _anchor.BN)(10);
var TEN_THOUSAND = new (0, _anchor.BN)(1e4);
var BN_MAX = new (0, _anchor.BN)(Number.MAX_SAFE_INTEGER);
var TEN_MILLION = TEN_THOUSAND.mul(TEN_THOUSAND);
var MAX_LEVERAGE = new (0, _anchor.BN)(5);
var PERCENTAGE_PRECISION_EXP = new (0, _anchor.BN)(6);
var PERCENTAGE_PRECISION = new (0, _anchor.BN)(10).pow(PERCENTAGE_PRECISION_EXP);
var CONCENTRATION_PRECISION = PERCENTAGE_PRECISION;
var QUOTE_PRECISION_EXP = new (0, _anchor.BN)(6);
var FUNDING_RATE_BUFFER_PRECISION_EXP = new (0, _anchor.BN)(3);
var PRICE_PRECISION_EXP = new (0, _anchor.BN)(6);
var FUNDING_RATE_PRECISION_EXP = PRICE_PRECISION_EXP.add(
  FUNDING_RATE_BUFFER_PRECISION_EXP
);
var PEG_PRECISION_EXP = new (0, _anchor.BN)(6);
var AMM_RESERVE_PRECISION_EXP = new (0, _anchor.BN)(9);
var SPOT_MARKET_RATE_PRECISION_EXP = new (0, _anchor.BN)(6);
var SPOT_MARKET_RATE_PRECISION = new (0, _anchor.BN)(10).pow(
  SPOT_MARKET_RATE_PRECISION_EXP
);
var SPOT_MARKET_CUMULATIVE_INTEREST_PRECISION_EXP = new (0, _anchor.BN)(10);
var SPOT_MARKET_CUMULATIVE_INTEREST_PRECISION = new (0, _anchor.BN)(10).pow(
  SPOT_MARKET_CUMULATIVE_INTEREST_PRECISION_EXP
);
var SPOT_MARKET_UTILIZATION_PRECISION_EXP = new (0, _anchor.BN)(6);
var SPOT_MARKET_UTILIZATION_PRECISION = new (0, _anchor.BN)(10).pow(
  SPOT_MARKET_UTILIZATION_PRECISION_EXP
);
var SPOT_MARKET_WEIGHT_PRECISION = new (0, _anchor.BN)(1e4);
var SPOT_MARKET_BALANCE_PRECISION_EXP = new (0, _anchor.BN)(9);
var SPOT_MARKET_BALANCE_PRECISION = new (0, _anchor.BN)(10).pow(
  SPOT_MARKET_BALANCE_PRECISION_EXP
);
var SPOT_MARKET_IMF_PRECISION_EXP = new (0, _anchor.BN)(6);
var SPOT_MARKET_IMF_PRECISION = new (0, _anchor.BN)(10).pow(
  SPOT_MARKET_IMF_PRECISION_EXP
);
var LIQUIDATION_FEE_PRECISION = new (0, _anchor.BN)(1e6);
var QUOTE_PRECISION = new (0, _anchor.BN)(10).pow(QUOTE_PRECISION_EXP);
var PRICE_PRECISION = new (0, _anchor.BN)(10).pow(PRICE_PRECISION_EXP);
var FUNDING_RATE_PRECISION = new (0, _anchor.BN)(10).pow(
  FUNDING_RATE_PRECISION_EXP
);
var FUNDING_RATE_BUFFER_PRECISION = new (0, _anchor.BN)(10).pow(
  FUNDING_RATE_BUFFER_PRECISION_EXP
);
var PEG_PRECISION = new (0, _anchor.BN)(10).pow(PEG_PRECISION_EXP);
var AMM_RESERVE_PRECISION = new (0, _anchor.BN)(10).pow(AMM_RESERVE_PRECISION_EXP);
...
var BID_ASK_SPREAD_PRECISION = new (0, _anchor.BN)(1e6);
var LIQUIDATION_PCT_PRECISION = TEN_THOUSAND;
var ONE_YEAR = new (0, _anchor.BN)(31536e3);
var QUOTE_SPOT_MARKET_INDEX = 0;
var LAMPORTS_PRECISION = new (0, _anchor.BN)(_web3js.LAMPORTS_PER_SOL);
var LAMPORTS_EXP = new (0, _anchor.BN)(Math.log10(_web3js.LAMPORTS_PER_SOL));
var OPEN_ORDER_MARGIN_REQUIREMENT = QUOTE_PRECISION.div(new (0, _anchor.BN)(100));
var DEFAULT_REVENUE_SINCE_LAST_FUNDING_SPREAD_RETREAT = new (0, _anchor.BN)(
  -25
).mul(QUOTE_PRECISION);
...
var PythClient = class {
  ...
  getOraclePriceDataFromBuffer(buffer) {
    const priceData = _client.parsePriceData.call(void 0, buffer);
    return {
      price: convertPythPrice(priceData.aggregate.price, priceData.exponent),
      slot: new (0, _anchor.BN)(priceData.lastSlot.toString()),
...
function convertPythPrice(price, exponent) {
  ...
  const pythPrecision = TEN.pow(new (0, _anchor.BN)(exponent).abs());
  return new (0, _anchor.BN)(price * Math.pow(10, exponent)).mul(PRICE_PRECISION).div(pythPrecision);
}
...
function getSwitchboardProgram(connection) {
  const DEFAULT_KEYPAIR = _web3js.Keypair.fromSeed(new Uint8Array(32).fill(1));
  const programId = _web3js.PublicKey.default;
  const wallet = new Wallet(DEFAULT_KEYPAIR);
  const provider = new (0, _anchor.AnchorProvider)(connection, wallet, {});
  return new (0, _anchor.Program)(switchboard_v2_default, programId, provider);
}
function convertSwitchboardDecimal(switchboardDecimal) {
  const switchboardPrecision = TEN.pow(new (0, _anchor.BN)(switchboardDecimal.scale));
...
var DevnetPerpMarkets = [
  {
    ...
    baseAssetSymbol: "SOL",
    marketIndex: 0,
    oracle: new (0, _web3js.PublicKey)("J83w4HKfqxwcq3BEMMkPFSppX3gqekLyLJBexebFVkix"),
  ...
  },
  {
    ...
    baseAssetSymbol: "BTC",
    marketIndex: 1,
    oracle: new (0, _web3js.PublicKey)("HovQMDrbAgAYPCmHVSrezcSmkMtXSSUsLDFANExrZh2J"),
    launchTs: 1655751353e3,
    oracleSource: OracleSource.PYTH
  },
  {
    ...
    baseAssetSymbol: "ETH",
    marketIndex: 2,
    oracle: new (0, _web3js.PublicKey)("EdVCmQ9FSPcVe5YySXDPCRmc8aDQLKJ9xvYBMZPie1Vw"),
...
var MainnetPerpMarkets = [
  {
    ...
    baseAssetSymbol: "SOL",
    marketIndex: 0,
    oracle: new (0, _web3js.PublicKey)("H6ARHf6YXhGYeQfUzQNGk6rDNnLBQKrenN712K4AQJEG"),
  ...
  },
  {
    ...
    baseAssetSymbol: "BTC",
    marketIndex: 1,
    oracle: new (0, _web3js.PublicKey)("GVXRSBjFk6e6J3NbVPXohDJetcTjaeeuykUpbQF8UoMU"),
  ...
  },
  {
    ...
    baseAssetSymbol: "ETH",
    marketIndex: 2,
    oracle: new (0, _web3js.PublicKey)("JBu1AL4obBcCMqKBBxhpWCNUt136ijcuMZLFvTP7iWdB"),
    launchTs: 1670347281e3,
    oracleSource: OracleSource.PYTH
  }
];
...
async function getDriftStateAccountPublicKeyAndNonce(programId) {
  return _web3js.PublicKey.findProgramAddress(
...
var QUOTE_ORACLE_PRICE_DATA = {
  ...
  slot: new (0, _anchor.BN)(0),
  confidence: new (0, _anchor.BN)(1),
  hasSufficientNumberOfDataPoints: true
};
...
var WebSocketDriftClientAccountSubscriber = class {
  constructor(program2, perpMarketIndexes, spotMarketIndexes, oracleInfos) {
    ...
    this.program = program2;
    this.eventEmitter = new (0, _events2.EventEmitter)();
  ...
  async subscribeToOracles() {
    for (const oracleInfo of this.oracleInfos) {
      if (!oracleInfo.publicKey.equals(_web3js.PublicKey.default)) {
  ...
  getOraclePriceDataAndSlot(oraclePublicKey) {
    this.assertIsSubscribed();
    if (oraclePublicKey.equals(_web3js.PublicKey.default)) {
      return {
...
var BulkAccountLoader = class {
  ...
  async addAccount(publicKey, callback) {
    ...
    const callbackId = _uuid.v4.call(void 0, );
...
function parseTokenAccount(data) {
  const accountInfo = _spltoken.AccountLayout.decode(data);
  ...
  if (accountInfo.delegateOption === 0) {
    ...
    accountInfo.delegatedAmount = new (0, _spltoken.u64)(0);
  } else {
    accountInfo.delegate = new (0, _web3js.PublicKey)(accountInfo.delegate);
    accountInfo.delegatedAmount = _spltoken.u64.fromBuffer(accountInfo.delegatedAmount);
  }
  accountInfo.isInitialized = accountInfo.state !== 0;
  accountInfo.isFrozen = accountInfo.state === 2;
  if (accountInfo.isNativeOption === 1) {
    accountInfo.rentExemptReserve = _spltoken.u64.fromBuffer(accountInfo.isNative);
  ...
  if (accountInfo.closeAuthorityOption === 0) {
    ...
    accountInfo.closeAuthority = new (0, _web3js.PublicKey)(accountInfo.closeAuthority);
  }
  return accountInfo;
}
...
function clampBN(x, min, max) {
  return _anchor.BN.max(min, _anchor.BN.min(x, max));
}
var squareRootBN = (n, closeness = new (0, _anchor.BN)(1)) => {
  let x = n;
  let root;
  let count = 0;
  const TWO2 = new (0, _anchor.BN)(2);
...
function wrapInTx(instruction, computeUnits = 6e5) {
  ...
  if (computeUnits != COMPUTE_UNITS_DEFAULT) {
    tx.add(
      _web3js.ComputeBudgetProgram.requestUnits({
        units: computeUnits,
        additionalFee: 0
      })
    );
...
function calculateAdjustKCost(amm, numerator, denomenator) {
  ...
  return cost.mul(new (0, _anchor.BN)(-1));
}
...
function calculateBudgetedKBN(x, y, budget, Q, d) {
  assert(Q.gt(new (0, _anchor.BN)(0)));
  const C = budget.mul(new (0, _anchor.BN)(-1));
  let dSign = new (0, _anchor.BN)(1);
  if (d.lt(new (0, _anchor.BN)(0))) {
    dSign = new (0, _anchor.BN)(-1);
  }
  ...
  if (C.lt(ZERO)) {
    if (denom1.abs().gt(denom2.abs())) {
      ...
      return [new (0, _anchor.BN)(1e4), new (0, _anchor.BN)(1)];
    }
  }
...
function calculateBudgetedPeg(amm, cost, targetPrice) {
  ...
  const d = amm.baseAssetAmountWithAmm;
  const Q = amm.pegMultiplier;
  const C = cost.mul(new (0, _anchor.BN)(-1));
...
function oraclePriceBands(market, oraclePriceData) {
  ...
  const offset = oraclePriceData.price.mul(new (0, _anchor.BN)(maxPercentDiff)).div(MARGIN_PRECISION);
...
function isOracleValid(amm, oraclePriceData, oracleGuardRails, slot) {
  ...
  const isOraclePriceTooVolatile = oraclePriceData.price.div(_anchor.BN.max(ONE, amm.historicalOracleData.lastOraclePriceTwap)).gt(oracleGuardRails.validity.tooVolatileRatio) || amm.historicalOracleData.lastOraclePriceTwap.div(_anchor.BN.max(ONE, oraclePriceData.price)).gt(oracleGuardRails.validity.tooVolatileRatio);
  const isConfidenceTooLarge = new (0, _anchor.BN)(amm.baseSpread).add(_anchor.BN.max(ONE, oraclePriceData.confidence)).mul(BID_ASK_SPREAD_PRECISION).div(oraclePriceData.price).gt(new (0, _anchor.BN)(amm.maxSpread));
  const oracleIsStale = oraclePriceData.slot.sub(new (0, _anchor.BN)(slot)).gt(oracleGuardRails.validity.slotsBeforeStaleForAmm);
...
function isOracleTooDivergent(amm, oraclePriceData, oracleGuardRails, now) {
  ...
  const sinceStart = _anchor.BN.max(ZERO, new (0, _anchor.BN)(60 * 5).sub(sinceLastUpdate));
...
function calculateLiveOracleTwap(amm, oraclePriceData, now) {
  ...
  const sinceStart = _anchor.BN.max(ZERO, amm.fundingPeriod.sub(sinceLastUpdate));
  const clampRange = amm.historicalOracleData.lastOraclePriceTwap.div(
    new (0, _anchor.BN)(3)
  );
  const clampedOraclePrice = _anchor.BN.min(
...
function calculatePegFromTargetPrice(targetPrice, baseAssetReserve, quoteAssetReserve) {
  return _anchor.BN.max(
    targetPrice.mul(baseAssetReserve).div(quoteAssetReserve).add(PRICE_DIV_PEG.div(new (0, _anchor.BN)(2))).div(PRICE_DIV_PEG),
    ONE
  );
}
function calculateOptimalPegAndBudget(amm, oraclePriceData) {
  ...
  const totalFeeLB = amm.totalExchangeFee.div(new (0, _anchor.BN)(2));
  const budget = _anchor.BN.max(ZERO, amm.totalFeeMinusDistributions.sub(totalFeeLB));
  if (budget.lt(prePegCost)) {
    const halfMaxPriceSpread = new (0, _anchor.BN)(amm.maxSpread).div(new (0, _anchor.BN)(2)).mul(targetPrice).div(BID_ASK_SPREAD_PRECISION);
    let newTargetPrice;
    let newOptimalPeg;
    let newBudget;
    ...
    if (targetPriceGap.abs().gt(halfMaxPriceSpread)) {
      ...
      if (targetPriceGap.lt(new (0, _anchor.BN)(0))) {
...
function calculateNewAmm(amm, oraclePriceData) {
  let pKNumer = new (0, _anchor.BN)(1);
  let pKDenom = new (0, _anchor.BN)(1);
  ...
  if (prePegCost.gt(budget) && checkLowerBound) {
    [pKNumer, pKDenom] = [new (0, _anchor.BN)(999), new (0, _anchor.BN)(1e3)];
    const deficitMadeup = calculateAdjustKCost(amm, pKNumer, pKDenom);
    assert(deficitMadeup.lte(new (0, _anchor.BN)(0)));
...
function calculateMarketOpenBidAsk(baseAssetReserve, minBaseAssetReserve, maxBaseAssetReserve) {
  ...
  if (maxBaseAssetReserve.gt(baseAssetReserve)) {
    openAsks = maxBaseAssetReserve.sub(baseAssetReserve).mul(new (0, _anchor.BN)(-1));
  } else {
    openAsks = ZERO;
  }
  let openBids;
...
function calculateInventoryScale(baseAssetAmountWithAmm, baseAssetReserve, minBaseAssetReserve, maxBaseAssetReserve, directionalSpread, maxSpread) {
  ...
  const defaultLargeBidAskFactor = BID_ASK_SPREAD_PRECISION.mul(new (0, _anchor.BN)(10));
  const [openBids, openAsks] = calculateMarketOpenBidAsk(
    baseAssetReserve,
    minBaseAssetReserve,
    maxBaseAssetReserve
  );
  const minSideLiquidity = _anchor.BN.max(
    new (0, _anchor.BN)(1),
    _anchor.BN.min(openBids.abs(), openAsks.abs())
  );
  const inventoryScaleMaxBN = _anchor.BN.max(
    defaultLargeBidAskFactor,
    new (0, _anchor.BN)(maxSpread / 2).mul(BID_ASK_SPREAD_PRECISION).div(new (0, _anchor.BN)(Math.max(directionalSpread, 1)))
  );
  const inventoryScaleBN = baseAssetAmountWithAmm.mul(_anchor.BN.max(baseAssetAmountWithAmm.abs(), BASE_PRECISION)).div(BASE_PRECISION).mul(defaultLargeBidAskFactor).div(minSideLiquidity).abs();
  const inventoryScale = _anchor.BN.min(inventoryScaleMaxBN, inventoryScaleBN).toNumber() / BID_ASK_SPREAD_PRECISION.toNumber();
...
function calculateMaxSpread(marginRatioInitial) {
  const maxTargetSpread = new (0, _anchor.BN)(marginRatioInitial).mul(BID_ASK_SPREAD_PRECISION.div(MARGIN_PRECISION)).toNumber();
...
function calculateVolSpreadBN(lastOracleConfPct, reservePrice, markStd, oracleStd, longIntensity, shortIntensity, volume24H) {
  const marketAvgStdPct = markStd.add(oracleStd).mul(PERCENTAGE_PRECISION).div(reservePrice).div(new (0, _anchor.BN)(2));
  const volSpread = _anchor.BN.max(lastOracleConfPct, marketAvgStdPct.div(new (0, _anchor.BN)(2)));
  const clampMin = PERCENTAGE_PRECISION.div(new (0, _anchor.BN)(100));
  const clampMax = PERCENTAGE_PRECISION.mul(new (0, _anchor.BN)(16)).div(new (0, _anchor.BN)(10));
  const longVolSpreadFactor = clampBN(
    longIntensity.mul(PERCENTAGE_PRECISION).div(_anchor.BN.max(ONE, volume24H)),
    clampMin,
    clampMax
  );
  const shortVolSpreadFactor = clampBN(
    shortIntensity.mul(PERCENTAGE_PRECISION).div(_anchor.BN.max(ONE, volume24H)),
    clampMin,
    clampMax
  );
  const longVolSpread = _anchor.BN.max(
    lastOracleConfPct,
    volSpread.mul(longVolSpreadFactor).div(PERCENTAGE_PRECISION)
  );
  const shortVolSpread = _anchor.BN.max(
    lastOracleConfPct,
...
function calculateSpread(amm, oraclePriceData, now) {
  ...
  now = now || new (0, _anchor.BN)(new Date().getTime() / 1e3);
...
function calculateSpreadReserves(amm, oraclePriceData, now) {
  function calculateSpreadReserve(spread, direction, amm2) {
    ...
    const quoteAssetReserveDelta = amm2.quoteAssetReserve.div(
      BID_ASK_SPREAD_PRECISION.div(new (0, _anchor.BN)(spread / 2))
    );
...
function calculateMaxBaseAssetAmountToTrade(amm, limit_price, direction, oraclePriceData, now) {
  ...
  if (newBaseAssetReserve.gt(baseAssetReserveBefore)) {
    ...
    return [new (0, _anchor.BN)(0), PositionDirection.LONG];
  }
}
...
function calculateMaxBaseAssetAmountFillable(amm, orderDirection) {
  const maxFillSize = amm.baseAssetReserve.div(
    new (0, _anchor.BN)(amm.maxFillReserveFraction)
  );
  let maxBaseAssetAmountOnSide;
  if (isVariant(orderDirection, "long")) {
    maxBaseAssetAmountOnSide = _anchor.BN.max(
      ZERO,
  ...
  return standardizeBaseAssetAmount(
    _anchor.BN.min(maxFillSize, maxBaseAssetAmountOnSide),
    amm.orderStepSize
  );
}
...
function calculateSizePremiumLiabilityWeight(size, imfFactor, liabilityWeight, precision) {
  ...
  const sizeSqrt = squareRootBN(size.mul(new (0, _anchor.BN)(10)).add(new (0, _anchor.BN)(1)));
  const denom0 = _anchor.BN.max(new (0, _anchor.BN)(1), SPOT_MARKET_IMF_PRECISION.div(imfFactor));
  assert(denom0.gt(ZERO));
  const liabilityWeightNumerator = liabilityWeight.sub(
    liabilityWeight.div(
      _anchor.BN.max(new (0, _anchor.BN)(1), SPOT_MARKET_IMF_PRECISION.div(imfFactor))
    )
  );
  const denom = new (0, _anchor.BN)(1e5).mul(SPOT_MARKET_IMF_PRECISION).div(precision);
  assert(denom.gt(ZERO));
  const sizePremiumLiabilityWeight = liabilityWeightNumerator.add(
    sizeSqrt.mul(imfFactor).div(denom)
  );
  const maxLiabilityWeight = _anchor.BN.max(
    liabilityWeight,
...
function calculateSizeDiscountAssetWeight(size, imfFactor, assetWeight) {
  ...
  const imfNumerator = SPOT_MARKET_IMF_PRECISION.add(
    SPOT_MARKET_IMF_PRECISION.div(new (0, _anchor.BN)(10))
  );
  const sizeDiscountAssetWeight = imfNumerator.mul(SPOT_MARKET_WEIGHT_PRECISION).div(
    SPOT_MARKET_IMF_PRECISION.add(
      sizeSqrt.mul(imfFactor).div(new (0, _anchor.BN)(1e5))
    )
  );
  const minAssetWeight = _anchor.BN.min(assetWeight, sizeDiscountAssetWeight);
  return minAssetWeight;
}
function calculateOraclePriceForPerpMargin(perpPosition, market, oraclePriceData) {
  const oraclePriceOffset = _anchor.BN.min(
    new (0, _anchor.BN)(market.amm.maxSpread).mul(oraclePriceData.price).div(BID_ASK_SPREAD_PRECISION),
    oraclePriceData.confidence.add(
      new (0, _anchor.BN)(market.amm.baseSpread).mul(oraclePriceData.price).div(BID_ASK_SPREAD_PRECISION)
    )
  );
  let marginPrice;
...
function getBalance(tokenAmount, spotMarket, balanceType) {
  const precisionIncrease = TEN.pow(new (0, _anchor.BN)(19 - spotMarket.decimals));
...
function getTokenAmount(balanceAmount, spotMarket, balanceType) {
  const precisionDecrease = TEN.pow(new (0, _anchor.BN)(19 - spotMarket.decimals));
  const cumulativeInterest = isVariant(balanceType, "deposit") ? spotMarket.cumulativeDepositInterest : spotMarket.cumulativeBorrowInterest;
...
function getTokenValue(tokenAmount, spotDecimals, oraclePriceData) {
  ...
  const precisionDecrease = TEN.pow(new (0, _anchor.BN)(spotDecimals));
...
function calculateAssetWeight(balanceAmount, spotMarket, marginCategory) {
  const sizePrecision = TEN.pow(new (0, _anchor.BN)(spotMarket.decimals));
  ...
  switch (marginCategory) {
    case "Initial":
      assetWeight = calculateSizeDiscountAssetWeight(
        ...
        new (0, _anchor.BN)(spotMarket.imfFactor),
        new (0, _anchor.BN)(spotMarket.initialAssetWeight)
      );
      break;
    case "Maintenance":
      assetWeight = calculateSizeDiscountAssetWeight(
        sizeInAmmReservePrecision,
        new (0, _anchor.BN)(spotMarket.imfFactor),
        new (0, _anchor.BN)(spotMarket.maintenanceAssetWeight)
      );
      break;
    default:
      assetWeight = new (0, _anchor.BN)(spotMarket.initialAssetWeight);
      break;
  }
  return assetWeight;
}
  ...
  switch (marginCategory) {
    case "Initial":
      assetWeight = calculateSizePremiumLiabilityWeight(
        sizeInAmmReservePrecision,
        new (0, _anchor.BN)(spotMarket.imfFactor),
        new (0, _anchor.BN)(spotMarket.initialLiabilityWeight),
    ...
    case "Maintenance":
      assetWeight = calculateSizePremiumLiabilityWeight(
        sizeInAmmReservePrecision,
        new (0, _anchor.BN)(spotMarket.imfFactor),
        new (0, _anchor.BN)(spotMarket.maintenanceLiabilityWeight),
        SPOT_MARKET_WEIGHT_PRECISION
      );
      break;
    default:
...
function calculateInterestRate(bank) {
  ...
  let interestRate;
  if (utilization.gt(new (0, _anchor.BN)(bank.optimalUtilization))) {
    const surplusUtilization = utilization.sub(new (0, _anchor.BN)(bank.optimalUtilization));
    const borrowRateSlope = new (0, _anchor.BN)(bank.maxBorrowRate - bank.optimalBorrowRate).mul(SPOT_MARKET_UTILIZATION_PRECISION).div(
      SPOT_MARKET_UTILIZATION_PRECISION.sub(new (0, _anchor.BN)(bank.optimalUtilization))
    );
    interestRate = new (0, _anchor.BN)(bank.optimalBorrowRate).add(
      surplusUtilization.mul(borrowRateSlope).div(SPOT_MARKET_UTILIZATION_PRECISION)
    );
  } else {
    const borrowRateSlope = new (0, _anchor.BN)(bank.optimalBorrowRate).mul(SPOT_MARKET_UTILIZATION_PRECISION).div(
      SPOT_MARKET_UTILIZATION_PRECISION.sub(new (0, _anchor.BN)(bank.optimalUtilization))
    );
...
function calculateDepositRate(bank) {
  ...
  const depositRate = borrowRate.mul(PERCENTAGE_PRECISION.sub(new (0, _anchor.BN)(bank.insuranceFund.totalFactor))).mul(utilization).div(SPOT_MARKET_UTILIZATION_PRECISION).div(PERCENTAGE_PRECISION);
  return depositRate;
}
...
function calculateWithdrawLimit(spotMarket, now) {
  ...
  const twentyFourHours = new (0, _anchor.BN)(60 * 60 * 24);
  const sinceLast = now.sub(spotMarket.lastTwapTs);
  const sinceStart = _anchor.BN.max(ZERO, twentyFourHours.sub(sinceLast));
  ...
  const maxBorrowTokens = _anchor.BN.min(
    _anchor.BN.max(
      marketDepositTokenAmount.div(new (0, _anchor.BN)(6)),
      borrowTokenTwapLive.add(borrowTokenTwapLive.div(new (0, _anchor.BN)(5)))
    ),
    marketDepositTokenAmount.sub(marketDepositTokenAmount.div(new (0, _anchor.BN)(5)))
  );
  const minDepositTokens = depositTokenTwapLive.sub(
    _anchor.BN.min(
      _anchor.BN.max(
        depositTokenTwapLive.div(new (0, _anchor.BN)(5)),
  ...
  switch (marginCategory) {
    case "Initial":
      marginRatio = calculateSizePremiumLiabilityWeight(
        size,
        new (0, _anchor.BN)(market.imfFactor),
        new (0, _anchor.BN)(market.marginRatioInitial),
        MARGIN_PRECISION
      ).toNumber();
      break;
    case "Maintenance":
      marginRatio = calculateSizePremiumLiabilityWeight(
        size,
        new (0, _anchor.BN)(market.imfFactor),
        new (0, _anchor.BN)(market.marginRatioMaintenance),
        MARGIN_PRECISION
      ).toNumber();
      break;
  }
...
function calculateUnrealizedAssetWeight(market, quoteSpotMarket, unrealizedPnl, marginCategory, oraclePriceData) {
  ...
  switch (marginCategory) {
    case "Initial":
      assetWeight = new (0, _anchor.BN)(market.unrealizedPnlInitialAssetWeight);
      ...
      assetWeight = calculateSizeDiscountAssetWeight(
        unrealizedPnl,
        new (0, _anchor.BN)(market.unrealizedPnlImfFactor),
        assetWeight
      );
      break;
    case "Maintenance":
      assetWeight = new (0, _anchor.BN)(market.unrealizedPnlMaintenanceAssetWeight);
      break;
  }
  return assetWeight;
}
...
function calculatePositionPNL(market, perpPosition, withFunding = false, oraclePriceData) {
  ...
  const baseAssetValueSign = perpPosition.baseAssetAmount.isNeg() ? new (0, _anchor.BN)(-1) : new (0, _anchor.BN)(1);
...
function calculatePositionFundingPNL(market, perpPosition) {
  ...
  const perPositionFundingRate = ammCumulativeFundingRate.sub(perpPosition.lastCumulativeFundingRate).mul(perpPosition.baseAssetAmount).div(AMM_RESERVE_PRECISION).div(FUNDING_RATE_BUFFER_PRECISION).mul(new (0, _anchor.BN)(-1));
...
var RetryTxSender = class {
  ...
  async confirmTransaction(signature, commitment) {
    ...
    try {
      decodedSignature = _bs582.default.decode(signature);
    } catch (err) {
      throw new Error("signature must be base58 encoded: " + signature);
    }
    _assert2.default.call(void 0, decodedSignature.length === 64, "signature has invalid length");
...
var User = class {
  ...
  getSettledLPPosition(marketIndex) {
    ...
    function sign(v) {
      const sign2 = { true: new (0, _anchor.BN)(1), false: new (0, _anchor.BN)(-1) }[v.gte(ZERO).toString()];
      return sign2;
    }
    ...
    if (Math.abs(position.remainderBaseAssetAmount) > market.amm.orderStepSize.toNumber()) {
      const [newStandardizedBaa, newRemainderBaa] = standardize(
        new (0, _anchor.BN)(position.remainderBaseAssetAmount),
        market.amm.orderStepSize
      );
    ...
    return this.getActivePerpPositions().filter((pos) => marketIndex ? pos.marketIndex === marketIndex : true).reduce((unrealizedPnl, perpPosition) => {
      ...
      if (withWeightMarginCategory !== void 0) {
        if (positionUnrealizedPnl.gt(ZERO)) {
          ...
          ).div(new (0, _anchor.BN)(SPOT_MARKET_WEIGHT_PRECISION));
        }
      }
    ...
    return this.getUserAccount().spotPositions.reduce(
      (totalLiabilityValue, spotPosition) => {
        ...
        if (spotPosition.marketIndex === QUOTE_SPOT_MARKET_INDEX) {
          if (isVariant(spotPosition.balanceType, "borrow")) {
            ...
            if (marginCategory === "Initial") {
              weight = _anchor.BN.max(
                weight,
                new (0, _anchor.BN)(this.getUserAccount().maxMarginRatio)
              );
            }
        ...
        newTotalLiabilityValue = newTotalLiabilityValue.add(
          new (0, _anchor.BN)(spotPosition.openOrders).mul(OPEN_ORDER_MARGIN_REQUIREMENT)
        );
  ...
  getSpotLiabilityValue(tokenAmount, oraclePriceData, spotMarketAccount, marginCategory, liquidationBuffer) {
    ...
    if (marginCategory !== void 0) {
      ...
      if (marginCategory === "Initial") {
        weight = _anchor.BN.max(weight, new (0, _anchor.BN)(this.getUserAccount().maxMarginRatio));
      }
  ...
  getTotalPerpPositionValue(marginCategory, liquidationBuffer, includeOpenOrders) {
    return this.getActivePerpPositions().reduce(
      (totalPerpValue, perpPosition) => {
        ...
        if (marginCategory) {
          let marginRatio = new (0, _anchor.BN)(
          ...
          if (includeOpenOrders) {
            baseAssetValue = baseAssetValue.add(
              new (0, _anchor.BN)(perpPosition.openOrders).mul(OPEN_ORDER_MARGIN_REQUIREMENT)
            );
          }
        }
  ...
  getMaxLeverage(marketIndex, category = "Initial") {
    ...
    const additionalLiabilities = freeCollateral.mul(MARGIN_PRECISION).div(new (0, _anchor.BN)(marginRatio));
  ...
  canBeLiquidated() {
    ...
    if (isBeingLiquidated) {
      liquidationBuffer = new (0, _anchor.BN)(
  ...
  spotLiquidationPrice(spotPosition) {
    ...
    const tokenAmountQP = tokenAmount.mul(QUOTE_PRECISION).div(new (0, _anchor.BN)(10 ** currentSpotMarket.decimals));
    if (tokenAmountQP.abs().eq(ZERO)) {
      return new (0, _anchor.BN)(-1);
    }
    let liqPriceDelta;
    if (isVariant(currentSpotPosition.balanceType, "borrow")) {
      liqPriceDelta = deltaValueToLiq.mul(PRICE_PRECISION).mul(SPOT_MARKET_WEIGHT_PRECISION).div(tokenAmountQP).div(new (0, _anchor.BN)(currentSpotMarket.maintenanceLiabilityWeight));
    } else {
      liqPriceDelta = deltaValueToLiq.mul(PRICE_PRECISION).mul(SPOT_MARKET_WEIGHT_PRECISION).div(tokenAmountQP).div(new (0, _anchor.BN)(currentSpotMarket.maintenanceAssetWeight)).mul(new (0, _anchor.BN)(-1));
    }
  ...
  liquidationPrice(perpPosition, positionBaseSizeChange = ZERO) {
    ...
    const proposedPerpPosition = {
      ...
      remainderBaseAssetAmount: 0,
      quoteAssetAmount: new (0, _anchor.BN)(0),
      lastCumulativeFundingRate: ZERO,
      quoteBreakEvenAmount: new (0, _anchor.BN)(0),
      quoteEntryAmount: new (0, _anchor.BN)(0),
      openOrders: 0,
      openBids: new (0, _anchor.BN)(0),
      openAsks: new (0, _anchor.BN)(0),
      settledPnl: ZERO,
      lpShares: ZERO,
      lastBaseAssetAmountPerLp: ZERO,
      lastQuoteAssetAmountPerLp: ZERO
    ...
    if (maxPositionSize.gte(ZERO)) {
      if (oppositeSizeValueUSDC.eq(ZERO)) {
        ...
        maxPositionSize = maxPositionSize.add(
          oppositeSizeValueUSDC.mul(new (0, _anchor.BN)(2))
        );
      }
    } else {
      if (!targetingSameSide) {
        ...
        const marginFreedByClosing = perpPositionValue.mul(new (0, _anchor.BN)(market.marginRatioInitial)).div(MARGIN_PRECISION);
  ...
  calculateFeeForQuoteAmount(quoteAmount) {
    ...
    return quoteAmount.mul(new (0, _anchor.BN)(feeTier.feeNumerator)).div(new (0, _anchor.BN)(feeTier.feeDenominator));
  }
  getWithdrawalLimit(marketIndex, reduceOnly) {
    const nowTs = new (0, _anchor.BN)(Math.floor(Date.now() / 1e3));
    ...
    const precisionIncrease = TEN.pow(new (0, _anchor.BN)(spotMarket.decimals - 6));
    const amountWithdrawable = freeCollateral.mul(MARGIN_PRECISION).div(new (0, _anchor.BN)(spotMarket.initialAssetWeight)).mul(PRICE_PRECISION).div(oracleData.price).mul(precisionIncrease);
    ...
    const maxWithdrawValue = _anchor.BN.min(
      _anchor.BN.min(amountWithdrawable, userSpotBalance),
      withdrawLimit.abs()
    );
    if (reduceOnly) {
      return _anchor.BN.max(maxWithdrawValue, ZERO);
    } else {
      ...
      const maxLiabilityAllowed = freeCollatAfterWithdraw.mul(MARGIN_PRECISION).div(new (0, _anchor.BN)(spotMarket.initialLiabilityWeight)).mul(PRICE_PRECISION).div(oracleData.price).mul(precisionIncrease);
      const maxBorrowValue = _anchor.BN.min(
        maxWithdrawValue.add(maxLiabilityAllowed),
        borrowLimit.abs()
      );
      return _anchor.BN.max(maxBorrowValue, ZERO);
    }
  }
...
var WRAPPED_SOL_MINT = new (0, _web3js.PublicKey)(
...
var DevnetSpotMarkets = [
  {
    symbol: "USDC",
    marketIndex: 0,
    oracle: _web3js.PublicKey.default,
    oracleSource: OracleSource.QUOTE_ASSET,
    mint: new (0, _web3js.PublicKey)("8zGuJQqwhZafTah7Uc7Z4tXRnguqkn5KLFAP8oV6PHe2"),
    precision: new (0, _anchor.BN)(10).pow(SIX),
    precisionExp: SIX
  },
  {
    symbol: "SOL",
    ...
    oracle: new (0, _web3js.PublicKey)("J83w4HKfqxwcq3BEMMkPFSppX3gqekLyLJBexebFVkix"),
    oracleSource: OracleSource.PYTH,
    mint: new (0, _web3js.PublicKey)(WRAPPED_SOL_MINT),
    precision: LAMPORTS_PRECISION,
    precisionExp: LAMPORTS_EXP,
    serumMarket: new (0, _web3js.PublicKey)("8N37SsnTu8RYxtjrV9SStjkkwVhmU8aCWhLvwduAPEKW")
  },
  {
    symbol: "BTC",
    marketIndex: 2,
    oracle: new (0, _web3js.PublicKey)("HovQMDrbAgAYPCmHVSrezcSmkMtXSSUsLDFANExrZh2J"),
    oracleSource: OracleSource.PYTH,
    mint: new (0, _web3js.PublicKey)("3BZPwbcqB5kKScF3TEXxwNfx5ipV13kbRVDvfVp5c6fv"),
    precision: new (0, _anchor.BN)(10).pow(SIX),
    precisionExp: SIX,
    serumMarket: new (0, _web3js.PublicKey)("AGsmbVu3MS9u68GEYABWosQQCZwmLcBHu4pWEuBYH7Za")
  }
];
var MainnetSpotMarkets = [
  {
    ...
    oracle: _web3js.PublicKey.default,
    oracleSource: OracleSource.QUOTE_ASSET,
    mint: new (0, _web3js.PublicKey)("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"),
  ...
  },
  {
    ...
    precision: LAMPORTS_PRECISION,
    precisionExp: LAMPORTS_EXP,
    serumMarket: new (0, _web3js.PublicKey)("8BnEgHoWFysVcuFFX7QztDmzuH8r5ZFvyP3sYwn1XTh6")
  }
];
var SpotMarkets = {
...
var UserStats = class {
  ...
  getReferrerInfo() {
    if (this.getAccount().referrer.equals(_web3js.PublicKey.default)) {
      return void 0;
    } else {
      return {
...
var DriftClient = class {
  constructor(config) {
    ...
    this.opts = config.opts || _anchor.AnchorProvider.defaultOptions();
    this.provider = new (0, _anchor.AnchorProvider)(
      config.connection,
      config.wallet,
      this.opts
    );
    this.program = new (0, _anchor.Program)(
      drift_default,
      config.programID,
      this.provider
    );
  ...
  async updateWallet(newWallet, subAccountIds = [0], activeSubAccountId = 0) {
    const newProvider = new (0, _anchor.AnchorProvider)(
      this.connection,
      newWallet,
      this.opts
    );
    const newProgram = new (0, _anchor.Program)(
      drift_default,
      this.program.programId,
      newProvider
    );
  ...
  async getInitializeUserInstructions(subAccountId = 0, name = DEFAULT_USER_NAME, referrerInfo) {
    ...
    if (!state.whitelistMint.equals(_web3js.PublicKey.default)) {
      const associatedTokenPublicKey = await _spltoken.Token.getAssociatedTokenAddress(
        _spltoken.ASSOCIATED_TOKEN_PROGRAM_ID,
        _spltoken.TOKEN_PROGRAM_ID,
        state.whitelistMint,
        this.wallet.publicKey
    ...
    const programAccounts = await this.program.account.user.all([
      {
        memcmp: {
          offset: 40,
          bytes: _bs582.default.encode(delegate.toBuffer())
        }
      }
    ]);
    ...
    const programAccounts = await this.program.account.user.all([
      {
        memcmp: {
          offset: 8,
          bytes: _bs582.default.encode(authority.toBuffer())
        }
      }
    ]);
    return programAccounts.map(
  ...
  getRemainingAccounts(params) {
    ...
    if (params.useMarketLastSlotCache) {
      ...
      for (const [
        ...
        if (slot > lastUserSlot) {
          ...
          if (!marketAccount.oracle.equals(_web3js.PublicKey.default)) {
    ...
    if (params.writableSpotMarketIndexes !== void 0) {
      for (const writableSpotMarketIndex of params.writableSpotMarketIndexes) {
        ...
        if (!spotMarketAccount.oracle.equals(_web3js.PublicKey.default)) {
          oracleAccountMap.set(spotMarketAccount.oracle.toString(), {
            pubkey: spotMarketAccount.oracle,
            isSigner: false,
            isWritable: false
    ...
    for (const userAccount of userAccounts) {
      for (const spotPosition of userAccount.spotPositions) {
        if (!isSpotPositionAvailable(spotPosition)) {
          ...
          if (!spotMarket.oracle.equals(_web3js.PublicKey.default)) {
  ...
  async deposit(amount, marketIndex, collateralAccountPublicKey, subAccountId, reduceOnly = false) {
    ...
    if (createWSOLTokenAccount) {
      tx.add(
        _spltoken.Token.createCloseAccountInstruction(
          _spltoken.TOKEN_PROGRAM_ID,
          collateralAccountPublicKey,
          authority,
          authority,
  ...
  async getWrappedSolAccountCreationIxs(amount, isDeposit) {
    const wrappedSolAccount = new (0, _web3js.Keypair)();
    const result = {
      ixs: [],
      signers: [],
      pubkey: wrappedSolAccount.publicKey
    };
    const rentSpaceLamports = new (0, _anchor.BN)(_web3js.LAMPORTS_PER_SOL / 100);
    ...
    result.ixs.push(
      _spltoken.Token.createInitAccountInstruction(
        _spltoken.TOKEN_PROGRAM_ID,
        WRAPPED_SOL_MINT,
  ...
  async initializeUserAccountForDevnet(subAccountId = 0, name = DEFAULT_USER_NAME, marketIndex, tokenFaucet, amount, referrerInfo) {
    ...
    const tx = new (0, _web3js.Transaction)().add(createAssociatedAccountIx).add(mintToIx);
    if (subAccountId === 0) {
      if (!await this.checkIfAccountExists(this.getUserStatsAccountPublicKey())) {
        tx.add(await this.getInitializeUserStatsIx());
      }
...
var MAXPCT = new (0, _anchor.BN)(1e3);
...
function calculateTargetPriceTrade(market, targetPrice, pct = MAXPCT, outputAssetType = "quote", oraclePriceData, useSpread = true) {
  ...
  const biasModifier = new (0, _anchor.BN)(1);
  let markPriceAfter;
...
var _BigNum = class {
  constructor(val, precisionVal = new (0, _anchor.BN)(0)) {
    this.toString = (base, length) => this.val.toString(base, length);
    this.val = new (0, _anchor.BN)(val);
    this.precision = new (0, _anchor.BN)(precisionVal);
  }
  ...
  bigNumFromParam(bn) {
    return _anchor.BN.isBN(bn) ? _BigNum.from(bn) : bn;
  }
  add(bn) {
  ...
  shift(exponent, skipAdjustingPrecision = false) {
    const shiftVal = typeof exponent === "number" ? new (0, _anchor.BN)(exponent) : exponent;
    return _BigNum.from(
      shiftVal.isNeg() ? this.val.div(new (0, _anchor.BN)(10).pow(shiftVal)) : this.val.mul(new (0, _anchor.BN)(10).pow(shiftVal)),
  ...
  scale(numerator, denominator) {
    return this.mul(_BigNum.from(new (0, _anchor.BN)(numerator))).div(new (0, _anchor.BN)(denominator));
  }
  ...
  toRounded(roundingPrecision) {
    ...
    if (shouldRoundUp) {
      const valueWithRoundedPrecisionAdded = this.add(
        _BigNum.from(
          new (0, _anchor.BN)(10).pow(new (0, _anchor.BN)(printString.length - roundingPrecision)),
          this.precision
        )
      );
  ...
  toNotional(useTradePrecision, precisionOverride) {
    ...
    let val = usingCustomPrecision ? this.prettyPrint(useTradePrecision, precisionOverride) : _BigNum.fromPrint(this.toFixed(2), new (0, _anchor.BN)(2)).prettyPrint();
  ...
  toMillified(precision = 3, rounded = false) {
    ...
    if (!leftSide) {
      return this.shift(new (0, _anchor.BN)(precision)).toPrecision(precision, true);
    }
  ...
  static fromJSON(json) {
    return _BigNum.from(new (0, _anchor.BN)(json.val), new (0, _anchor.BN)(json.precision));
  }
  static from(val = ZERO, precision) {
    assert(
      new (0, _anchor.BN)(precision).lt(new (0, _anchor.BN)(100)),
  ...
  static fromPrint(val, precisionShift) {
    ...
    const rawBn = new (0, _anchor.BN)(bnInput);
    const rightSideLength = (_a = rightSide == null ? void 0 : rightSide.length) != null ? _a : 0;
    const totalShift = precisionShift ? precisionShift.sub(new (0, _anchor.BN)(rightSideLength)) : ZERO;
...
function isAuctionComplete(order, slot) {
  ...
  return new (0, _anchor.BN)(slot).sub(order.slot).gt(new (0, _anchor.BN)(order.auctionDuration));
}
...
function getAuctionPriceForFixedAuction(order, slot) {
  const slotsElapsed = new (0, _anchor.BN)(slot).sub(order.slot);
  const deltaDenominator = new (0, _anchor.BN)(order.auctionDuration);
  const deltaNumerator = _anchor.BN.min(slotsElapsed, deltaDenominator);
...
function castNumberToSpotPrecision(value, spotMarket) {
  return new (0, _anchor.BN)(value * Math.pow(10, spotMarket.decimals));
}
...
async function calculateAllEstimatedFundingRate(market, oraclePriceData, periodAdjustment = new (0, _anchor.BN)(1)) {
  const secondsInHour = new (0, _anchor.BN)(3600);
  const hoursInDay = new (0, _anchor.BN)(24);
  const ONE2 = new (0, _anchor.BN)(1);
  if (isVariant(market.status, "uninitialized")) {
    return [ZERO, ZERO, ZERO, ZERO, ZERO];
  }
  const payFreq = new (0, _anchor.BN)(market.amm.fundingPeriod);
  const now = new (0, _anchor.BN)((Date.now() / 1e3).toFixed(0));
  const timeSinceLastUpdate = now.sub(market.amm.lastFundingRateTs);
  const lastMarkTwapWithMantissa = market.amm.lastMarkPriceTwap;
  const lastMarkPriceTwapTs = market.amm.lastMarkPriceTwapTs;
  const timeSinceLastMarkChange = now.sub(lastMarkPriceTwapTs);
  const markTwapTimeSinceLastUpdate = _anchor.BN.max(
    secondsInHour,
    _anchor.BN.max(ZERO, secondsInHour.sub(timeSinceLastMarkChange))
  );
  const [bid, ask] = calculateBidAskPrice(market.amm, oraclePriceData);
  const baseAssetPriceWithMantissa = bid.add(ask).div(new (0, _anchor.BN)(2));
  ...
  const oracleInvalidDuration = _anchor.BN.max(
    ZERO,
    lastMarkPriceTwapTs.sub(lastOraclePriceTwapTs)
  );
  const timeSinceLastOracleTwapUpdate = now.sub(lastOraclePriceTwapTs);
  const oracleTwapTimeSinceLastUpdate = _anchor.BN.max(
    ONE2,
    _anchor.BN.min(
      secondsInHour,
      _anchor.BN.max(ONE2, secondsInHour.sub(timeSinceLastOracleTwapUpdate))
    )
  );
  let oracleTwapWithMantissa = lastOracleTwapWithMantissa;
  if (oraclePriceData) {
    const oraclePrice = oraclePriceData.price;
    const oracleLiveVsTwap = oraclePrice.sub(lastOracleTwapWithMantissa).abs().mul(PRICE_PRECISION).mul(new (0, _anchor.BN)(100)).div(lastOracleTwapWithMantissa);
    if (oracleLiveVsTwap.lte(PRICE_PRECISION.mul(new (0, _anchor.BN)(10)))) {
  ...
  const twapSpreadPct = twapSpread.mul(PRICE_PRECISION).mul(new (0, _anchor.BN)(100)).div(shrunkLastOracleTwapwithMantissa);
  const lowerboundEst = twapSpreadPct.mul(payFreq).mul(_anchor.BN.min(secondsInHour, timeSinceLastUpdate)).mul(periodAdjustment).div(secondsInHour).div(secondsInHour).div(hoursInDay);
  ...
  if (interpRateQuote.lt(new (0, _anchor.BN)(0))) {
    feePoolSize = feePoolSize.mul(new (0, _anchor.BN)(-1));
  }
  let cappedAltEst;
  let largerSide;
  let smallerSide;
  if (market.amm.baseAssetAmountLong.gt(market.amm.baseAssetAmountShort.abs())) {
    ...
    if (twapSpread.gt(new (0, _anchor.BN)(0))) {
      return [
    ...
    if (twapSpread.lt(new (0, _anchor.BN)(0))) {
      return [
        markTwapWithMantissa,
        oracleTwapWithMantissa,
        lowerboundEst,
  ...
  if (largerSide.gt(ZERO)) {
    ...
    cappedAltEst = cappedAltEst.mul(PRICE_PRECISION).mul(new (0, _anchor.BN)(100)).div(oracleTwapWithMantissa).mul(periodAdjustment);
...
async function calculateEstimatedFundingRate(market, oraclePriceData, periodAdjustment = new (0, _anchor.BN)(1), estimationMethod) {
...
async function calculateLongShortFundingRate(market, oraclePriceData, periodAdjustment = new (0, _anchor.BN)(1)) {
...
async function calculateLongShortFundingRateAndLiveTwaps(market, oraclePriceData, periodAdjustment = new (0, _anchor.BN)(1)) {
...
function calculateFundingPool(market) {
  const totalFeeLB = market.amm.totalExchangeFee.div(new (0, _anchor.BN)(2));
  const feePool = _anchor.BN.max(
    ZERO,
    market.amm.totalFeeMinusDistributions.sub(totalFeeLB).mul(new (0, _anchor.BN)(1)).div(new (0, _anchor.BN)(3))
  );
  return feePool;
}
...
function getLimitPrice(order, oraclePriceData, slot, fallbackPrice) {
  ...
  if (hasAuctionPrice(order, slot)) {
    ...
    limitPrice = oraclePriceData.price.add(new (0, _anchor.BN)(order.oraclePriceOffset));
...
function calculateBaseAssetAmountForAmmToFulfill(order, market, oraclePriceData, slot) {
  ...
  return _anchor.BN.min(maxBaseAssetAmount, baseAssetAmount);
}
...
function isOrderExpired(order, ts) {
  ...
  return new (0, _anchor.BN)(ts).gt(order.maxTs);
}
...
var SerumSubscriber = class {
  ...
  async subscribe() {
    ...
    this.market = await _serum.Market.load(
      this.connection,
      this.marketAddress,
      void 0,
      this.programId
    ...
    this.asksCallbackId = await this.accountLoader.addAccount(
      ...
      (buffer, slot) => {
        ...
        this.asks = _serum.Orderbook.decode(this.market, buffer);
      }
    );
    ...
    this.bidsCallbackId = await this.accountLoader.addAccount(
      ...
      (buffer, slot) => {
        ...
        this.bids = _serum.Orderbook.decode(this.market, buffer);
      }
    );
  ...
  getBestBid() {
    ...
    return new (0, _anchor.BN)(bestBid[0] * PRICE_PRECISION.toNumber());
  }
  getBestAsk() {
    ...
    return new (0, _anchor.BN)(bestAsk[0] * PRICE_PRECISION.toNumber());
  }
  async unsubscribe() {
    if (!this.subscribed) {
      return;
...
var FloatingLimitOrderNode = class extends OrderNode {
  getSortValue(order) {
    return new (0, _anchor.BN)(order.oraclePriceOffset);
  }
};
  ...
  findMarketNodesCrossingLimitNodes(marketIndex, slot, marketType, oraclePriceData, takerNodeGenerator, makerNodeGeneratorFn, doesCross) {
    ...
    for (const takerNode of takerNodeGenerator) {
      ...
      for (const makerNode of makerNodeGenerator) {
        ...
        const baseFilled = _anchor.BN.min(makerBaseRemaining, takerBaseRemaining);
  ...
  *getBids(marketIndex, fallbackBid, slot, marketType, oraclePriceData) {
  ...
  findCrossingLimitOrders(marketIndex, slot, marketType, oraclePriceData) {
    ...
    for (const askNode of this.getLimitAsks(
      ...
      for (const bidNode of this.getLimitBids(
        ...
        const baseFilled = _anchor.BN.min(bidBaseRemaining, askBaseRemaining);
  ...
  printTopOfOrderLists(sdkConfig, driftClient, slotSubscriber, marketIndex, marketType) {
    if (isVariant(marketType, "perp")) {
      ...
      const mid = bestAsk.add(bestBid).div(new (0, _anchor.BN)(2));
...
var _idl = require('@project-serum/anchor/dist/cjs/coder/borsh/idl');
...
var DLOBOrdersCoder = class {
  ...
  encode(dlobOrders) {
    const layout = _idl.IdlCoder.fieldLayout(
      {
        type: {
          vec: {
            defined: "DLOBOrder"
...
var UserMap2 = class {
  ...
  async mustGet(key) {
    if (!this.has(key)) {
      await this.addPubkey(new (0, _web3js.PublicKey)(key));
    }
...
var UserStatsMap = class {
  ...
  async mustGet(authorityPublicKey) {
    if (!this.has(authorityPublicKey)) {
      await this.addUserStat(new (0, _web3js.PublicKey)(authorityPublicKey));
    }
...
exports.AMM_RESERVE_PRECISION = AMM_RESERVE_PRECISION; exports.AMM_RESERVE_PRECISION_EXP = AMM_RESERVE_PRECISION_EXP; exports.AMM_TIMES_PEG_TO_QUOTE_PRECISION_RATIO = AMM_TIMES_PEG_TO_QUOTE_PRECISION_RATIO; exports.AMM_TO_QUOTE_PRECISION_RATIO = AMM_TO_QUOTE_PRECISION_RATIO; exports.AdminClient = AdminClient; exports.AssetTier = AssetTier; exports.BASE_PRECISION = BASE_PRECISION; exports.BASE_PRECISION_EXP = BASE_PRECISION_EXP; exports.BID_ASK_SPREAD_PRECISION = BID_ASK_SPREAD_PRECISION; exports.BN = _anchor.BN; exports.BN_MAX = BN_MAX; exports.BigNum = BigNum; exports.BulkAccountLoader = BulkAccountLoader; exports.CONCENTRATION_PRECISION = CONCENTRATION_PRECISION; exports.ContractTier = ContractTier; exports.ContractType = ContractType; exports.DEFAULT_REVENUE_SINCE_LAST_FUNDING_SPREAD_RETREAT = DEFAULT_REVENUE_SINCE_LAST_FUNDING_SPREAD_RETREAT; exports.DLOB = DLOB; exports.DLOBOrdersCoder = DLOBOrdersCoder; exports.DefaultEventSubscriptionOptions = DefaultEventSubscriptionOptions; exports.DefaultOrderParams = DefaultOrderParams; exports.DepositDirection = DepositDirection; exports.DepositExplanation = DepositExplanation; exports.DevnetPerpMarkets = DevnetPerpMarkets; exports.DevnetSpotMarkets = DevnetSpotMarkets; exports.DriftClient = DriftClient; exports.EIGHT = EIGHT; exports.EventSubscriber = EventSubscriber; exports.ExchangeStatus = ExchangeStatus; exports.FIVE = FIVE; exports.FOUR = FOUR; exports.FUNDING_RATE_BUFFER_PRECISION = FUNDING_RATE_BUFFER_PRECISION; exports.FUNDING_RATE_BUFFER_PRECISION_EXP = FUNDING_RATE_BUFFER_PRECISION_EXP; exports.FUNDING_RATE_PRECISION = FUNDING_RATE_PRECISION; exports.FUNDING_RATE_PRECISION_EXP = FUNDING_RATE_PRECISION_EXP; exports.FloatingLimitOrderNode = FloatingLimitOrderNode; exports.LAMPORTS_EXP = LAMPORTS_EXP; exports.LAMPORTS_PRECISION = LAMPORTS_PRECISION; exports.LIQUIDATION_FEE_PRECISION = LIQUIDATION_FEE_PRECISION; exports.LIQUIDATION_PCT_PRECISION = LIQUIDATION_PCT_PRECISION; exports.LPAction = LPAction; exports.LimitOrderNode = LimitOrderNode; exports.LiquidationType = LiquidationType; exports.LogParser = LogParser; exports.MARGIN_PRECISION = MARGIN_PRECISION; exports.MAX_LEVERAGE = MAX_LEVERAGE; exports.MainnetPerpMarkets = MainnetPerpMarkets; exports.MainnetSpotMarkets = MainnetSpotMarkets; exports.MarketOrderNode = MarketOrderNode; exports.MarketStatus = MarketStatus; exports.MarketType = MarketType; exports.NINE = NINE; exports.NodeList = NodeList; exports.NotSubscribedError = NotSubscribedError; exports.ONE = ONE; exports.ONE_YEAR = ONE_YEAR; exports.OPEN_ORDER_MARGIN_REQUIREMENT = OPEN_ORDER_MARGIN_REQUIREMENT; exports.OracleSource = OracleSource; exports.OrderAction = OrderAction; exports.OrderActionExplanation = OrderActionExplanation; exports.OrderNode = OrderNode; exports.OrderStatus = OrderStatus; exports.OrderTriggerCondition = OrderTriggerCondition; exports.OrderType = OrderType; exports.PEG_PRECISION = PEG_PRECISION; exports.PEG_PRECISION_EXP = PEG_PRECISION_EXP; exports.PERCENTAGE_PRECISION = PERCENTAGE_PRECISION; exports.PERCENTAGE_PRECISION_EXP = PERCENTAGE_PRECISION_EXP; exports.PRICE_DIV_PEG = PRICE_DIV_PEG; exports.PRICE_PRECISION = PRICE_PRECISION; exports.PRICE_PRECISION_EXP = PRICE_PRECISION_EXP; exports.PRICE_TO_QUOTE_PRECISION = PRICE_TO_QUOTE_PRECISION; exports.PerpMarkets = PerpMarkets; exports.PollingDriftClientAccountSubscriber = PollingDriftClientAccountSubscriber; exports.PollingOracleAccountSubscriber = PollingOracleAccountSubscriber; exports.PollingTokenAccountSubscriber = PollingTokenAccountSubscriber; exports.PollingUserAccountSubscriber = PollingUserAccountSubscriber; exports.PollingUserStatsAccountSubscriber = PollingUserStatsAccountSubscriber; exports.PositionDirection = PositionDirection; exports.PublicKey = _web3js.PublicKey; exports.PythClient = PythClient; exports.QUOTE_PRECISION = QUOTE_PRECISION; exports.QUOTE_PRECISION_EXP = QUOTE_PRECISION_EXP; exports.QUOTE_SPOT_MARKET_INDEX = QUOTE_SPOT_MARKET_INDEX; exports.RetryTxSender = RetryTxSender; exports.SEVEN = SEVEN; exports.SIX = SIX; exports.SPOT_MARKET_BALANCE_PRECISION = SPOT_MARKET_BALANCE_PRECISION; exports.SPOT_MARKET_BALANCE_PRECISION_EXP = SPOT_MARKET_BALANCE_PRECISION_EXP; exports.SPOT_MARKET_CUMULATIVE_INTEREST_PRECISION = SPOT_MARKET_CUMULATIVE_INTEREST_PRECISION; exports.SPOT_MARKET_CUMULATIVE_INTEREST_PRECISION_EXP = SPOT_MARKET_CUMULATIVE_INTEREST_PRECISION_EXP; exports.SPOT_MARKET_IMF_PRECISION = SPOT_MARKET_IMF_PRECISION; exports.SPOT_MARKET_IMF_PRECISION_EXP = SPOT_MARKET_IMF_PRECISION_EXP; exports.SPOT_MARKET_RATE_PRECISION = SPOT_MARKET_RATE_PRECISION; exports.SPOT_MARKET_RATE_PRECISION_EXP = SPOT_MARKET_RATE_PRECISION_EXP; exports.SPOT_MARKET_UTILIZATION_PRECISION = SPOT_MARKET_UTILIZATION_PRECISION; exports.SPOT_MARKET_UTILIZATION_PRECISION_EXP = SPOT_MARKET_UTILIZATION_PRECISION_EXP; exports.SPOT_MARKET_WEIGHT_PRECISION = SPOT_MARKET_WEIGHT_PRECISION; exports.SerumFulfillmentConfigMap = SerumFulfillmentConfigMap; exports.SerumSubscriber = SerumSubscriber; exports.SettlePnlExplanation = SettlePnlExplanation; exports.SlotSubscriber = SlotSubscriber; exports.SpotBalanceType = SpotBalanceType; exports.SpotFulfillmentConfigStatus = SpotFulfillmentConfigStatus; exports.SpotFulfillmentStatus = SpotFulfillmentStatus; exports.SpotFulfillmentType = SpotFulfillmentType; exports.SpotMarkets = SpotMarkets; exports.StakeAction = StakeAction; exports.SwapDirection = SwapDirection; exports.SwitchboardClient = SwitchboardClient; exports.TEN = TEN; exports.TEN_MILLION = TEN_MILLION; exports.TEN_THOUSAND = TEN_THOUSAND; exports.THREE = THREE; exports.TWO = TWO; exports.TokenFaucet = TokenFaucet; exports.TradeSide = TradeSide; exports.TriggerOrderNode = TriggerOrderNode; exports.User = User; exports.UserMap = UserMap2; exports.UserStats = UserStats; exports.UserStatsMap = UserStatsMap; exports.UserStatus = UserStatus; exports.WRAPPED_SOL_MINT = WRAPPED_SOL_MINT; exports.Wallet = Wallet; exports.WebSocketDriftClientAccountSubscriber = WebSocketDriftClientAccountSubscriber; exports.ZERO = ZERO; exports.ammPaused = ammPaused; exports.bulkPollingUserStatsSubscribe = bulkPollingUserStatsSubscribe; exports.bulkPollingUserSubscribe = bulkPollingUserSubscribe; exports.calculateAdjustKCost = calculateAdjustKCost; exports.calculateAllEstimatedFundingRate = calculateAllEstimatedFundingRate; exports.calculateAmmReservesAfterSwap = calculateAmmReservesAfterSwap; exports.calculateAskPrice = calculateAskPrice; exports.calculateAssetWeight = calculateAssetWeight; exports.calculateBaseAssetAmountForAmmToFulfill = calculateBaseAssetAmountForAmmToFulfill; exports.calculateBaseAssetAmountToFillUpToLimitPrice = calculateBaseAssetAmountToFillUpToLimitPrice; exports.calculateBaseAssetValue = calculateBaseAssetValue; exports.calculateBaseAssetValueWithOracle = calculateBaseAssetValueWithOracle; exports.calculateBidAskPrice = calculateBidAskPrice; exports.calculateBidPrice = calculateBidPrice; exports.calculateBorrowRate = calculateBorrowRate; exports.calculateBreakEvenPrice = calculateBreakEvenPrice; exports.calculateBudgetedK = calculateBudgetedK; exports.calculateBudgetedKBN = calculateBudgetedKBN; exports.calculateBudgetedPeg = calculateBudgetedPeg; exports.calculateClaimablePnl = calculateClaimablePnl; exports.calculateCostBasis = calculateCostBasis; exports.calculateDepositRate = calculateDepositRate; exports.calculateEffectiveLeverage = calculateEffectiveLeverage; exports.calculateEntryPrice = calculateEntryPrice; exports.calculateEstimatedFundingRate = calculateEstimatedFundingRate; exports.calculateFundingPool = calculateFundingPool; exports.calculateInterestAccumulated = calculateInterestAccumulated; exports.calculateInterestRate = calculateInterestRate; exports.calculateInventoryScale = calculateInventoryScale; exports.calculateLiabilityWeight = calculateLiabilityWeight; exports.calculateLiveOracleStd = calculateLiveOracleStd; exports.calculateLiveOracleTwap = calculateLiveOracleTwap; exports.calculateLongShortFundingRate = calculateLongShortFundingRate; exports.calculateLongShortFundingRateAndLiveTwaps = calculateLongShortFundingRateAndLiveTwaps; exports.calculateMarketAvailablePNL = calculateMarketAvailablePNL; exports.calculateMarketMarginRatio = calculateMarketMarginRatio; exports.calculateMarketOpenBidAsk = calculateMarketOpenBidAsk; exports.calculateMaxBaseAssetAmountFillable = calculateMaxBaseAssetAmountFillable; exports.calculateMaxBaseAssetAmountToTrade = calculateMaxBaseAssetAmountToTrade; exports.calculateMaxSpread = calculateMaxSpread; exports.calculateNetUserPnl = calculateNetUserPnl; exports.calculateNetUserPnlImbalance = calculateNetUserPnlImbalance; exports.calculateNewAmm = calculateNewAmm; exports.calculateNewMarketAfterTrade = calculateNewMarketAfterTrade; exports.calculateOptimalPegAndBudget = calculateOptimalPegAndBudget; exports.calculateOraclePriceForPerpMargin = calculateOraclePriceForPerpMargin; exports.calculateOracleReserveSpread = calculateOracleReserveSpread; exports.calculateOracleSpread = calculateOracleSpread; exports.calculatePegFromTargetPrice = calculatePegFromTargetPrice; exports.calculatePositionFundingPNL = calculatePositionFundingPNL; exports.calculatePositionPNL = calculatePositionPNL; exports.calculatePrice = calculatePrice; exports.calculateQuoteAssetAmountSwapped = calculateQuoteAssetAmountSwapped; exports.calculateRepegCost = calculateRepegCost; exports.calculateReservePrice = calculateReservePrice; exports.calculateSizeDiscountAssetWeight = calculateSizeDiscountAssetWeight; exports.calculateSizePremiumLiabilityWeight = calculateSizePremiumLiabilityWeight; exports.calculateSpread = calculateSpread; exports.calculateSpreadBN = calculateSpreadBN; exports.calculateSpreadReserves = calculateSpreadReserves; exports.calculateSwapOutput = calculateSwapOutput; exports.calculateTargetPriceTrade = calculateTargetPriceTrade; exports.calculateTerminalPrice = calculateTerminalPrice; exports.calculateTradeAcquiredAmounts = calculateTradeAcquiredAmounts; exports.calculateTradeSlippage = calculateTradeSlippage; exports.calculateUnrealizedAssetWeight = calculateUnrealizedAssetWeight; exports.calculateUpdatedAMM = calculateUpdatedAMM; exports.calculateUpdatedAMMSpreadReserves = calculateUpdatedAMMSpreadReserves; exports.calculateUtilization = calculateUtilization; exports.calculateVolSpreadBN = calculateVolSpreadBN; exports.calculateWithdrawLimit = calculateWithdrawLimit; exports.calculateWorstCaseBaseAssetAmount = calculateWorstCaseBaseAssetAmount; exports.castNumberToSpotPrecision = castNumberToSpotPrecision; exports.clampBN = clampBN; exports.configs = configs; exports.convertPythPrice = convertPythPrice; exports.convertToNumber = convertToNumber; exports.createNode = createNode; exports.estimateTps = estimateTps; exports.exchangePaused = exchangePaused; exports.fetchLogs = fetchLogs; exports.fetchUserAccounts = fetchUserAccounts; exports.fetchUserStatsAccount = fetchUserStatsAccount; exports.fillPaused = fillPaused; exports.findComputeUnitConsumption = findComputeUnitConsumption; exports.findDirectionToClose = findDirectionToClose; exports.getAuctionPrice = getAuctionPrice; exports.getAuctionPriceForFixedAuction = getAuctionPriceForFixedAuction; exports.getAuctionPriceForOracleOffsetAuction = getAuctionPriceForOracleOffsetAuction; exports.getBalance = getBalance; exports.getConfig = getConfig; exports.getDriftSignerPublicKey = getDriftSignerPublicKey; exports.getDriftStateAccountPublicKey = getDriftStateAccountPublicKey; exports.getDriftStateAccountPublicKeyAndNonce = getDriftStateAccountPublicKeyAndNonce; exports.getInsuranceFundStakeAccountPublicKey = getInsuranceFundStakeAccountPublicKey; exports.getInsuranceFundVaultPublicKey = getInsuranceFundVaultPublicKey; exports.getLimitOrderParams = getLimitOrderParams; exports.getLimitPrice = getLimitPrice; exports.getMarketOrderParams = getMarketOrderParams; exports.getMarketsAndOraclesForSubscription = getMarketsAndOraclesForSubscription; exports.getOracleClient = getOracleClient; exports.getOrderSignature = getOrderSignature; exports.getPerpMarketPublicKey = getPerpMarketPublicKey; exports.getSerumFulfillmentConfigPublicKey = getSerumFulfillmentConfigPublicKey; exports.getSerumOpenOrdersPublicKey = getSerumOpenOrdersPublicKey; exports.getSerumSignerPublicKey = getSerumSignerPublicKey; exports.getSignedTokenAmount = getSignedTokenAmount; exports.getSpotMarketPublicKey = getSpotMarketPublicKey; exports.getSpotMarketVaultPublicKey = getSpotMarketVaultPublicKey; exports.getSwapDirection = getSwapDirection; exports.getTokenAmount = getTokenAmount; exports.getTokenValue = getTokenValue; exports.getTriggerLimitOrderParams = getTriggerLimitOrderParams; exports.getTriggerMarketOrderParams = getTriggerMarketOrderParams; exports.getUserAccountPublicKey = getUserAccountPublicKey; exports.getUserAccountPublicKeyAndNonce = getUserAccountPublicKeyAndNonce; exports.getUserAccountPublicKeySync = getUserAccountPublicKeySync; exports.getUserStatsAccountPublicKey = getUserStatsAccountPublicKey; exports.getVammNodeGenerator = getVammNodeGenerator; exports.getVariant = getVariant; exports.hasAuctionPrice = hasAuctionPrice; exports.hasLimitPrice = hasLimitPrice; exports.initialize = initialize; exports.isAuctionComplete = isAuctionComplete; exports.isEmptyPosition = isEmptyPosition; exports.isFillableByVAMM = isFillableByVAMM; exports.isLimitOrder = isLimitOrder; exports.isMarketOrder = isMarketOrder; exports.isOneOfVariant = isOneOfVariant; exports.isOracleTooDivergent = isOracleTooDivergent; exports.isOracleValid = isOracleValid; exports.isOrderExpired = isOrderExpired; exports.isOrderReduceOnly = isOrderReduceOnly; exports.isOrderRiskIncreasing = isOrderRiskIncreasing; exports.isOrderRiskIncreasingInSameDirection = isOrderRiskIncreasingInSameDirection; exports.isTriggered = isTriggered; exports.isVariant = isVariant; exports.mustBeTriggered = mustBeTriggered; exports.oraclePriceBands = oraclePriceBands; exports.positionCurrentDirection = positionCurrentDirection; exports.positionIsAvailable = positionIsAvailable; exports.promiseTimeout = promiseTimeout; exports.pyth = _client2.default; exports.squareRootBN = squareRootBN; exports.stakeAmountToShares = stakeAmountToShares; exports.standardizeBaseAssetAmount = standardizeBaseAssetAmount; exports.unstakeSharesToAmount = unstakeSharesToAmount;
