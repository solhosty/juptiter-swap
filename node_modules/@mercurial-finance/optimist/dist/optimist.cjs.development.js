...
class TransactionError extends Error {
  constructor(m, txid, code, programIds) {
    ...
    this.txid = txid;
    this.code = code;
    this.programIds = programIds; // Set the prototype explicitly.
      ...
      if (typeof errorMsg === 'string') {
        if (errorMsg === 'ProgramFailedToComplete') {
          if (tx !== null && tx !== void 0 && tx.meta && tx.meta.logMessages) {
            ...
            const failedProgramIds = getFailedExceededInstructionsPrograms((_tx$meta2 = tx.meta) === null || _tx$meta2 === void 0 ? void 0 : _tx$meta2.logMessages);
        ...
        if (tx !== null && tx !== void 0 && tx.meta && tx.meta.logMessages) {
          ...
          const failedProgramId = getFailedProgram((_tx$meta3 = tx.meta) === null || _tx$meta3 === void 0 ? void 0 : _tx$meta3.logMessages, errorCode);
...
async function pollForConfirmedTransaction(connection, txid) {
  return promiseRetry__default["default"](async retry => {
...
async function getWSolATA(connection, publicKey) {
  const wSolAddress = await splToken.Token.getAssociatedTokenAddress(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, new web3_js.PublicKey(SOL_MINT), publicKey);
...
async function createAndTransferWSOLInstructions(connection, publicKey, amountToTransferInLamports) {
  ...
  if (!wSolAccount.accountInfo) {
    // Create ATA account
    instructions.push(splToken.Token.createAssociatedTokenAccountInstruction(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, new web3_js.PublicKey(SOL_MINT), wSolAccount.address, publicKey, publicKey));
...
exports.createAndTransferWSOLInstructions = createAndTransferWSOLInstructions;
exports.createUnwrapSolInstructions = createUnwrapSolInstructions;
...
exports.pollForConfirmedTransaction = pollForConfirmedTransaction;
