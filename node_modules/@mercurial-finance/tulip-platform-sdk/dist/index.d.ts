...
var http_rpc_url = "https://api.mainnet-beta.solana.com";
var ws_rpc_url = "ws://api.mainnet-beta.solana.com";
var key_path = "/tmp/id.json";
var db_url = "postgres://postgres:password123@postgres/liquidator";
var log_file = "liquidator.log";
var analytics_api = "http://192.168.254.6:6969";
var programs = {
	pyth: {
...
declare const MEMO_PROGRAM_ID: anchor.web3.PublicKey;
declare const SERUM_PROGRAM_ID_V2 = "EUqojwWA2rd19FZrzeBncJsm38Jm1hEhE3zsmX3bRc2o";
declare const SERUM_PROGRAM_ID_V3 = "9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin";
declare const LIQUIDITY_POOL_PROGRAM_ID_V2 = "RVKd61ztZW9GUwhRbbLoYVRE5Xf1B2tVscKqwZqXgEr";
declare const LIQUIDITY_POOL_PROGRAM_ID_V3 = "27haf8L6oxUeXrHrgEgsexjSY5hbVUWEmvv9Nyxg8vQv";
declare const LIQUIDITY_POOL_PROGRAM_ID_V4 = "675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8";
declare const STAKE_PROGRAM_ID = "EhhTKczWMGQt46ynNeRX1WfeagwwJd7ufHvCDjRxjo5Q";
declare const STAKE_PROGRAM_ID_V4 = "CBuCnLe26faBpcBP2fktp4rp8abpcAnTWft6ZrP5Q4T";
declare const STAKE_PROGRAM_ID_V5 = "9KEPoZmtHUrBbhWN1v1KWLMkkvwY6WLtAVUCPRtRjP4z";
declare const LENDING_PROGRAM_ID: anchor.web3.PublicKey;
declare const QUARRY_MINE_PROGRAM: anchor.web3.PublicKey;
declare const SUNNY_QUARRY_PROGRAM: anchor.web3.PublicKey;
declare const AQUAFARM_PROGRAM_ID: anchor.web3.PublicKey;
declare const ORCA_SWAP_PROGRAM_ID: anchor.web3.PublicKey;
declare const DEFAULT_PUBLIC_KEY = "11111111111111111111111111111111";
...
declare const LENDING_RESERVES: Array<LendingInterface>;

declare const NATIVE_SOL: {
    symbol: string;
    name: string;
    mintAddress: string;
    decimals: number;
...
declare const getLendingMarketAccount: () => string;
declare const getPriceFeedsForReserve: (name: any) => any;

declare const refreshReserve: ({ reserveAccount, priceAccount }: {
    reserveAccount: any;
    priceAccount: any;
}) => TransactionInstruction;

export { AQUAFARM_PROGRAM_ID, DEFAULT_PUBLIC_KEY, LENDING_PROGRAM_ID, LENDING_RESERVES, LIQUIDITY_POOL_PROGRAM_ID_V2, LIQUIDITY_POOL_PROGRAM_ID_V3, LIQUIDITY_POOL_PROGRAM_ID_V4, LP_TOKENS, LendingInterface, MEMO_PROGRAM_ID, NATIVE_SOL, ORCA_SWAP_PROGRAM_ID, QUARRY_MINE_PROGRAM, SERUM_PROGRAM_ID_V2, SERUM_PROGRAM_ID_V3, STAKE_PROGRAM_ID, STAKE_PROGRAM_ID_V4, STAKE_PROGRAM_ID_V5, SUNNY_QUARRY_PROGRAM, TOKENS, TOKEN_PROGRAM_ID, getLendingMarketAccount, getPriceFeedsForReserve, lending_info, refreshReserve };
