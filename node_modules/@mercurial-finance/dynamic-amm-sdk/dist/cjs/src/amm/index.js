...
class AmmImpl {
    ...
    static createMultiple(connection, poolList, opt) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const depegAccounts = yield (0, utils_1.getDepegAccounts)(ammProgram.provider.connection, poolsState);
    ...
    static create(connection, pool, tokenInfoA, tokenInfoB, opt) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const depegAccounts = yield (0, utils_1.getDepegAccounts)(ammProgram.provider.connection, [poolState]);
            let swapCurve;
            if ('stable' in poolState.curveType) {
                const { amp, depeg, tokenMultiplier } = poolState.curveType['stable'];
                swapCurve = new curve_1.StableSwap(amp.toNumber(), tokenMultiplier, depeg, depegAccounts, currentTime, poolState.stake);
