...
var CONFIGS = {
  localnet: {
    CYPHER_PID: new (0, _web3js.PublicKey)("E2hQJAedG6bX2w3rbPQ5XrBnPvC7u3mAorKLvU6XPxwe"),
    PYTH_PID: new (0, _web3js.PublicKey)("gSbePebfvPy7tRqimPoVecS2UsBvYv46ynrzWocc92s"),
    DEX_PID: new (0, _web3js.PublicKey)("EoTcMgcDRTJVZDMZWBoU6rhYHZfkNTVEAfz3uUJRcYGj"),
    FAUCET_PID: new (0, _web3js.PublicKey)("2gCkR5aaUiTVRiKDB79EWXm5PAVDWtNTnp9mGuu4ZKdY"),
    QUOTE_MINT: new (0, _web3js.PublicKey)("GE2GoxjfHo9uPJGDxwVifPFomBybhsh4m5SMqaw7vPBw"),
    PYTH_QUOTE_PRODUCT: new (0, _web3js.PublicKey)(
      "6NpdXrQEpmDZ3jZKmM2rhdmkd3H6QAk23j2x8bkXcHKA"
    ),
    CACHE: new (0, _web3js.PublicKey)("DV1umVB5KzBkPuav7JbDNNKUzaDk9v2zAUNudR3kKRmZ"),
  ...
  "mainnet-beta": {
    CYPHER_PID: new (0, _web3js.PublicKey)("CYPH3o83JX6jY6NkbproSpdmQ5VWJtxjfJ5P8veyYVu3"),
    PYTH_PID: new (0, _web3js.PublicKey)("FsJ3A3u2vn5cTVofAjvy6y5kwABJAqYWpe4975bi2epH"),
    DEX_PID: new (0, _web3js.PublicKey)("srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX"),
    QUOTE_MINT: new (0, _web3js.PublicKey)("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"),
    PYTH_QUOTE_PRODUCT: new (0, _web3js.PublicKey)(
      "8GWTTbNiXdmyZREXbjsZBmCRuzdPrW55dnZGDkTRjWvb"
    ),
    CACHE: new (0, _web3js.PublicKey)("6x5U4c41tfUYGEbTXofFiHcfyx3rqJZsT4emrLisNGGL"),
...
var CypherClient = class {
  constructor(cluster, rpcEndpoint, wallet, confirmOpts = _anchor.AnchorProvider.defaultOptions()) {
    this.cluster = cluster;
    const provider = {
      connection: new (0, _web3js.Connection)(rpcEndpoint, confirmOpts.commitment)
    };
    this._program = new (0, _anchor.Program)(
      cypher_default,
  ...
  connectWallet(wallet, confirmOpts = _anchor.AnchorProvider.defaultOptions()) {
    const provider = new (0, _anchor.AnchorProvider)(this.connection, wallet, confirmOpts);
    this._program = new (0, _anchor.Program)(
      cypher_default,
      CONFIGS[this.cluster].CYPHER_PID,
      provider
  ...
  get walletPubkey() {
    return _optionalChain([this, 'access', _ => _.anchorProvider, 'optionalAccess', _2 => _2.wallet, 'access', _3 => _3.publicKey]);
  }
  get cypherPID() {
  ...
  async sendAndConfirm(tx, signers, opts) {
    return _optionalChain([this, 'access', _4 => _4.anchorProvider, 'optionalAccess', _5 => _5.sendAndConfirm, 'call', _6 => _6(tx, signers, opts)]);
  }
...
var getDexVaultSigner = (dexMarket, vaultSignerNonce, dexPID) => {
  return _web3js.PublicKey.createProgramAddressSync(
    [dexMarket.toBuffer(), vaultSignerNonce.toArrayLike(Buffer, "le", 8)],
    dexPID
  );
};
var derivePublicClearingAddress = (cypherPID) => {
  const B_CLEARING = _anchor.utils.bytes.utf8.encode("CYPHER_CLEARING");
  return _anchor.utils.publicKey.findProgramAddressSync(
...
var derivePoolAddress = (poolName, cypherPID) => {
  const B_POOL = _anchor.utils.bytes.utf8.encode("CYPHER_POOL");
  return _anchor.utils.publicKey.findProgramAddressSync(
...
var derivePoolNodeAddress = (pool, nodeNumber, cypherPID) => {
  const B_POOL_NODE = _anchor.utils.bytes.utf8.encode("CYPHER_POOL_NODE");
  return _anchor.utils.publicKey.findProgramAddressSync(
...
var derivePoolNodeVaultAddress = (poolNode, cypherPID) => {
  const B_POOL_VAULT = _anchor.utils.bytes.utf8.encode("CYPHER_POOL_NODE_VAULT");
  return _anchor.utils.publicKey.findProgramAddressSync(
...
var derivePoolNodeVaultSigner = (poolNode, cypherPID) => {
  const B_POOL_NODE_VAULT_SIGNER = _anchor.utils.bytes.utf8.encode(
...
var deriveMarketAddress = (marketName, cypherPID) => {
  const B_CYPHER_MARKET = _anchor.utils.bytes.utf8.encode("CYPHER_MARKET");
  return _anchor.utils.publicKey.findProgramAddressSync(
...
var deriveOracleProductsAddress = (symbol, cypherPID) => {
  const B_CYPHER_MARKET = _anchor.utils.bytes.utf8.encode(
...
var deriveAccountAddress = (authority, accountNumber, cypherPID) => {
  const B_CYPHER_ACCOUNT = _anchor.utils.bytes.utf8.encode("CYPHER_ACCOUNT");
  return _anchor.utils.publicKey.findProgramAddressSync(
...
var deriveSubAccountAddress = (masterAccount, accountNumber, cypherPID) => {
  const B_CYPHER_SUB_ACCOUNT = _anchor.utils.bytes.utf8.encode("CYPHER_SUB_ACCOUNT");
  return _anchor.utils.publicKey.findProgramAddressSync(
    [
...
var deriveOrdersAccountAddress = (masterAccount, market, cypherPID) => {
  const B_ORDERS_ACCOUNT = _anchor.utils.bytes.utf8.encode(
...
var deriveSerumOrdersAccountAddress = (dexMarket, masterAccount, subAccount, cypherPID) => {
  const B_OPEN_ORDERS = _anchor.utils.bytes.utf8.encode("OPEN_ORDERS");
  return _anchor.utils.publicKey.findProgramAddressSync(
    [
      B_OPEN_ORDERS,
      dexMarket.toBuffer(),
...
exports.AccountAction = AccountAction; exports.AccountType = AccountType; exports.BPS_100_PERCENT = BPS_100_PERCENT; exports.CALLBACK_INFO_LEN = CALLBACK_INFO_LEN; exports.CONFIGS = CONFIGS; exports.ClearingAction = ClearingAction; exports.ClearingType = ClearingType; exports.CypherClient = CypherClient; exports.DerivativeOrderType = DerivativeOrderType; exports.FuturesOrdersAccountAction = FuturesOrdersAccountAction; exports.MarketType = MarketType; exports.OperatingStatus = OperatingStatus; exports.OrderType = OrderType; exports.ProductsType = ProductsType; exports.QUOTE_TOKEN_DECIMALS = QUOTE_TOKEN_DECIMALS; exports.SelfTradeBehavior = SelfTradeBehavior; exports.SettlementType = SettlementType; exports.Side = Side; exports.SubAccountAction = SubAccountAction; exports.SubAccountMargining = SubAccountMargining; exports.WhitelistStatus = WhitelistStatus; exports.deriveAccountAddress = deriveAccountAddress; exports.deriveMarketAddress = deriveMarketAddress; exports.deriveOracleProductsAddress = deriveOracleProductsAddress; exports.deriveOrdersAccountAddress = deriveOrdersAccountAddress; exports.derivePoolAddress = derivePoolAddress; exports.derivePoolNodeAddress = derivePoolNodeAddress; exports.derivePoolNodeVaultAddress = derivePoolNodeVaultAddress; exports.derivePoolNodeVaultSigner = derivePoolNodeVaultSigner; exports.derivePrivateClearingAddress = derivePrivateClearingAddress; exports.derivePublicClearingAddress = derivePublicClearingAddress; exports.deriveSerumOrdersAccountAddress = deriveSerumOrdersAccountAddress; exports.deriveSubAccountAddress = deriveSubAccountAddress; exports.getDexVaultSigner = getDexVaultSigner;
