import { PublicKey, Transaction, ConfirmOptions, Connection, Signer, TransactionInstruction } from '@solana/web3.js';
import { Event, BN as BN$1, AnchorProvider, MethodsNamespace, AccountNamespace } from '@project-serum/anchor';
...
type WhiteList = TypeDef<Cypher['accounts'][2], Cypher>;
type _FuturesMarket = TypeDef<Cypher['accounts'][3], Cypher>;
type _PerpetualMarket = TypeDef<Cypher['accounts'][4], Cypher>;
type OracleProductsState = TypeDef<Cypher['accounts'][5], Cypher>;
type OracleStub = TypeDef<Cypher['accounts'][6], Cypher>;
type _OrdersAccountState = TypeDef<Cypher['accounts'][7], Cypher>;
type PoolNodeState = TypeDef<Cypher['accounts'][8], Cypher>;
type _Pool = TypeDef<Cypher['accounts'][9], Cypher>;
type PriceHistory = TypeDef<Cypher['accounts'][10], Cypher>;
type _CypherAccount = TypeDef<Cypher['accounts'][11], Cypher>;
type _CypherSubAccount = TypeDef<Cypher['accounts'][12], Cypher>;
type LiquidityMiningArgs = TypeDef<Cypher['types'][0], Cypher>;
type FeeTierArgs = TypeDef<Cypher['types'][1], Cypher>;
...
type CreatePoolArgs = TypeDef<Cypher['types'][6], Cypher>;
...
type Cache = TypeDef<Cypher['types'][10], Cypher>;
type FeeTier = TypeDef<Cypher['types'][11], Cypher>;
type ClearingConfig = TypeDef<Cypher['types'][12], Cypher>;
type _MarketConfig = TypeDef<Cypher['types'][13], Cypher>;
type LiquidityMiningInfo = TypeDef<Cypher['types'][14], Cypher>;
type _AgnosticMarket = TypeDef<Cypher['types'][15], Cypher>;
type _OpenOrder = TypeDef<Cypher['types'][16], Cypher>;
type NodeInfo = TypeDef<Cypher['types'][17], Cypher>;
type PoolConfig = TypeDef<Cypher['types'][18], Cypher>;
type PriceHistoryConfig = TypeDef<Cypher['types'][19], Cypher>;
type PriceWithTs = TypeDef<Cypher['types'][20], Cypher>;
...
type OpenOrdersCache = TypeDef<Cypher['types'][25], Cypher>;
type AccountActionLog = Event<Cypher['events'][0]>;
type SubAccountActionLog = Event<Cypher['events'][1]>;
type ClearingActionLog = Event<Cypher['events'][2]>;
type MarketActionLog = Event<Cypher['events'][3]>;
type PoolActionLog = Event<Cypher['events'][4]>;
type WhitelistCreationLog = Event<Cypher['events'][5]>;
type OrdersAccountActionLog = Event<Cypher['events'][6]>;
type SettlePositionLog = Event<Cypher['events'][7]>;
type LiquidateCollateralLog = Event<Cypher['events'][8]>;
type DepositOrWithdrawLog = Event<Cypher['events'][9]>;
type OrderFillLog = Event<Cypher['events'][10]>;
declare class OperatingStatus {
    ...
    static readonly CancelOnly: {
        cancelOnly: {};
    };
    static readonly Halted: {
        halted: {};
    };
}
declare class OrderType {
    ...
    static readonly ImmediateOrCancel: {
        immediateOrCancel: {};
    };
    static readonly PostOnly: {
        postOnly: {};
    };
}
declare class DerivativeOrderType {
    static readonly Limit: {
        limit: {};
    };
    static readonly ImmediateOrCancel: {
...
declare class SelfTradeBehavior {
    static readonly DecrementTake: {
        decrementTake: {};
    };
    static readonly AbortTransaction: {
        abortTransaction: {};
    };
    static readonly CancelProvide: {
        cancelProvide: {};
    };
}
declare class AccountAction {
    ...
    static readonly SetDelegate: {
        setDelegate: {};
    };
}
declare class SubAccountAction {
    static readonly Create: {
        create: {};
    };
    static readonly Close: {
    ...
    static readonly ChangeMarginingType: {
        changeMarginingType: {};
    };
}
declare class ClearingAction {
    static readonly Create: {
        create: {};
    };
    static readonly Close: {
    ...
    static readonly SweepFee: {
        sweepFee: {};
    };
}
declare class FuturesOrdersAccountAction {
    static readonly Create: {
        create: {};
    };
    static readonly Close: {
...
declare class MarketType {
    ...
    static readonly PairFuture: {
        pairFuture: {};
    };
    static readonly PerpetualFuture: {
        perpetualFuture: {};
    };
    static readonly PreIDO: {
        PreIDO: {};
    };
    static readonly IndexFuture: {
        indexFuture: {};
    };
}
declare class SettlementType {
    static readonly CashSettled: {
        cashSettled: {};
    };
    static readonly PhysicalDelivery: {
        physicalDelivery: {};
    };
}
declare class ProductsType {
...
declare class SubAccountMargining {
...
declare class AccountType {
    static readonly Regular: {
        regulard: {};
    };
    static readonly Whitelisted: {
        whitelisted: {};
    };
}
interface ClearingState extends _Clearing {
    feeTiers: FeeTierArgs[];
}
interface AgnosticMarket extends _AgnosticMarket {
    config: MarketConfig;
}
interface FuturesMarketState extends _FuturesMarket {
    inner: AgnosticMarket;
}
interface PerpetualMarketState extends _PerpetualMarket {
    inner: AgnosticMarket;
}
interface CreateOracleProductsArgs extends _CreateOracleProductsArgs {
    productsType: ProductsType;
}
interface CreateClearingArgs extends _CreateClearingArgs {
    clearingType: ClearingType;
    feeTiers: FeeTierArgs[];
}
interface CreateFuturesMarketArgs extends _CreateFuturesMarketArgs {
    marketType: MarketType;
    deliveryType: SettlementType;
}
interface CreatePerpetualMarketArgs extends _CreatePerpetualMarketArgs {
    marketType: MarketType;
}
interface NewSpotOrderArgs extends _NewSpotOrderArgs {
    side: Side;
    orderType: OrderType;
    selfTradeBehavior: SelfTradeBehavior;
}
interface NewDerivativeOrderArgs extends _NewDerivativeOrderArgs {
    side: Side;
    orderType: DerivativeOrderType;
    selfTradeBehavior: SelfTradeBehavior;
}
interface CancelOrderArgs extends _CancelOrderArgs {
    side: Side;
}
interface MarketConfig extends _MarketConfig {
    marketType: MarketType;
    settlementType: SettlementType;
}
interface OpenOrder extends _OpenOrder {
    side: Side;
    orderType: DerivativeOrderType;
}
interface OrdersAccountState extends _OrdersAccountState {
    openOrders: OpenOrder[];
}
interface SubAccountCache extends _SubAccountCache {
    margining: SubAccountMargining;
}
interface CypherAccountState extends _CypherAccount {
    accountType: AccountType;
    subAccountCaches: SubAccountCache[];
}
interface CypherSubAccountState extends _CypherSubAccount {
    positions: PositionSlot[];
}
interface PoolState extends _Pool {
    config: PoolConfig;
    nodes: NodeInfo[];
}
interface PositionSlot extends _PositionSlot {
    spot: SpotPositionState;
    derivative: DerivativePositionState;
}
interface SpotPositionState extends _SpotPosition {
    openOrdersCache: OpenOrdersCache;
}
interface DerivativePositionState extends _DerivativePosition {
    openOrdersCache: OpenOrdersCache;
    marketType: MarketType;
}
interface CacheAccountState extends _CacheAccount {
    caches: Cache[];
}
...
type StateUpdateHandler<T> = (state: T) => void;
type CacheListenerCB = (cache: Cache) => void;
type ParsedOrderbook = [number, number][];
type OrderbookListenerCB = (bidsOrAsks: ParsedOrderbook) => void;
type FillsListenerCB = (fills: FillsExtended) => void;
type Fills = {
    price: number;
    amount: number;
}[];
...
declare class CypherClient {
    readonly cluster: Cluster;
    private _program;
    constructor(cluster: Cluster, rpcEndpoint: string, wallet?: Wallet, confirmOpts?: ConfirmOptions);
    connectWallet(wallet: Wallet, confirmOpts?: ConfirmOptions): void;
    ...
    sendAndConfirmIxs(ixs: TransactionInstruction[], signers?: Signer[], opts?: ConfirmOptions): Promise<string>;
}

declare const CALLBACK_INFO_LEN = 34;
declare const BPS_100_PERCENT = 10000;
declare const QUOTE_TOKEN_DECIMALS = 6;
declare const CONFIGS: {
    [key in Cluster]: Config;
};

declare const getDexVaultSigner: (dexMarket: PublicKey, vaultSignerNonce: BN, dexPID: PublicKey) => PublicKey;
declare const derivePublicClearingAddress: (cypherPID: PublicKey) => [PublicKey, number];
declare const derivePrivateClearingAddress: (clearingNumber: number, cypherPID: PublicKey) => [PublicKey, number];
declare const derivePoolAddress: (poolName: number[], cypherPID: PublicKey) => [PublicKey, number];
declare const derivePoolNodeAddress: (pool: PublicKey, nodeNumber: number, cypherPID: PublicKey) => [PublicKey, number];
declare const derivePoolNodeVaultAddress: (poolNode: PublicKey, cypherPID: PublicKey) => [PublicKey, number];
declare const derivePoolNodeVaultSigner: (poolNode: PublicKey, cypherPID: PublicKey) => [PublicKey, number];
declare const deriveMarketAddress: (marketName: number[], cypherPID: PublicKey) => [PublicKey, number];
declare const deriveOracleProductsAddress: (symbol: number[], cypherPID: PublicKey) => [PublicKey, number];
declare const deriveAccountAddress: (authority: PublicKey, accountNumber: number, cypherPID: PublicKey) => [PublicKey, number];
declare const deriveSubAccountAddress: (masterAccount: PublicKey, accountNumber: number, cypherPID: PublicKey) => [PublicKey, number];
declare const deriveOrdersAccountAddress: (masterAccount: PublicKey, market: PublicKey, cypherPID: PublicKey) => [PublicKey, number];
declare const deriveSerumOrdersAccountAddress: (dexMarket: PublicKey, masterAccount: PublicKey, subAccount: PublicKey, cypherPID: PublicKey) => [PublicKey, number];

export { AccountAction, AccountActionLog, AccountType, AgnosticMarket, BPS_100_PERCENT, CALLBACK_INFO_LEN, CONFIGS, Cache, CacheAccountState, CacheListenerCB, CancelOrderArgs, ClearingAction, ClearingActionLog, ClearingConfig, ClearingState, ClearingType, Cluster, Config, CreateClearingArgs, CreateFuturesMarketArgs, CreateOracleProductsArgs, CreatePerpetualMarketArgs, CreatePoolArgs, CypherAccountState, CypherClient, CypherSubAccountState, DepositOrWithdrawLog, DerivativeOrderType, DerivativePositionState, FeeTier, FeeTierArgs, Fills, FillsExtended, FillsListenerCB, FuturesMarketState, FuturesOrdersAccountAction, LiquidateCollateralLog, LiquidityMiningArgs, LiquidityMiningInfo, MarketActionLog, MarketConfig, MarketType, NewDerivativeOrderArgs, NewSpotOrderArgs, NodeInfo, OpenOrder, OpenOrdersCache, OperatingStatus, OracleProductsState, OracleStub, OrderFillLog, OrderType, OrderbookListenerCB, OrdersAccountActionLog, OrdersAccountState, ParsedOrderbook, PerpetualMarketState, PoolActionLog, PoolConfig, PoolNodeState, PoolState, PositionSlot, PriceHistory, PriceHistoryConfig, PriceWithTs, ProductsType, QUOTE_TOKEN_DECIMALS, SelfTradeBehavior, SettlePositionLog, SettlementType, Side, SpotPositionState, StateUpdateHandler, SubAccountAction, SubAccountActionLog, SubAccountCache, SubAccountMargining, Wallet, WhiteList, WhitelistCreationLog, WhitelistStatus, deriveAccountAddress, deriveMarketAddress, deriveOracleProductsAddress, deriveOrdersAccountAddress, derivePoolAddress, derivePoolNodeAddress, derivePoolNodeVaultAddress, derivePoolNodeVaultSigner, derivePrivateClearingAddress, derivePublicClearingAddress, deriveSerumOrdersAccountAddress, deriveSubAccountAddress, getDexVaultSigner };
