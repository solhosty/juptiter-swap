...
declare function getDeltafiDexV2(programId: PublicKey, provider?: AnchorProvider): Program<DeltafiDexV2>;

declare function getSwappedAmountsAndPriceImpactFromRawValue(swapInfo: SwapInfo, swapDirection: SwapDirection, rawAmountIn: BigNumber, marketPrice: BigNumber, marketPriceSellBase?: BigNumber, marketPriceSellQuote?: BigNumber): {
    amountIn: BigNumber;
    amountOut: BigNumber;
    priceImpact: BigNumber;
};
declare function checkIfReserveIsSufficient(baseReserve: BigNumber, quoteReserve: BigNumber, normalizedBaseReserve: BigNumber, normalizedQuoteReserve: BigNumber, swapConfig: SwapConfig): boolean;

export { DeltafiUser, FarmConfig, FarmInfo, FarmPosition, FarmUser, LiquidityProvider, MarketConfig, PoolState, SwapConfig, SwapDirection, SwapInfo, SwapType, checkIfReserveIsSufficient, getDeltafiDexV2, getSwappedAmountsAndPriceImpactFromRawValue };
