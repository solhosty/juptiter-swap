...
export declare const BONK_SWAP_PROGRAM_ID: PublicKey;
export declare const BONK_SWAP_STATE_ID: PublicKey;
export declare const BONK_SWAP_PROGRAM_AUTHORITY: PublicKey;
export declare const PHOENIX_PROGRAM_ID: PublicKey;
export declare const SYMMETRY_PROGRAM_ID: PublicKey;
...
type JUPITER_ERROR_TYPES = 'TransactionNotConfirmed' | 'BalancesNotExtractedProperly' | 'InsufficientSOL' | (typeof IDL.errors)[number]['name'];
