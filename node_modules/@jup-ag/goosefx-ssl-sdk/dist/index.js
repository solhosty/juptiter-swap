...
var _bufferlayout = require('@solana/buffer-layout'); var lo = _interopRequireWildcard(_bufferlayout); var lo2 = _interopRequireWildcard(_bufferlayout); var lo3 = _interopRequireWildcard(_bufferlayout); var lo4 = _interopRequireWildcard(_bufferlayout); var lo5 = _interopRequireWildcard(_bufferlayout);
var _bufferlayoututils = require('@solana/buffer-layout-utils');
var CONTROLLER_LAYOUT = lo.struct([
  lo.blob(8, "sighash"),
  lo.blob(32, "seed"),
  lo.u8("bump"),
  _bufferlayoututils.publicKey.call(void 0, "admin"),
  lo.u8("suspended"),
  lo.u8("decimals"),
  _bufferlayoututils.publicKey.call(void 0, "mint"),
  lo.blob(5, "padding"),
  _bufferlayoututils.u64.call(void 0, "dailyReward"),
  _bufferlayoututils.u64.call(void 0, "totalStakingShare"),
  _bufferlayoututils.u64.call(void 0, "stakingBalance"),
  _bufferlayoututils.u64.call(void 0, "lastDistributionTime"),
  lo.u16("withdrawFee"),
  lo.blob(254, "padding")
]);
...
var LIQUIDITY_ACCOUNT_LAYOUT = lo2.struct([
  ...
  lo2.u8("bump"),
  lo2.blob(7),
  _bufferlayoututils.u64.call(void 0, "share"),
  _bufferlayoututils.u64.call(void 0, "ptMinted"),
  _bufferlayoututils.u64.call(void 0, "amountDeposited"),
...
var ORACLE_ELEMENT_LAYOUT = lo3.struct([
  _bufferlayoututils.publicKey.call(void 0, "address"),
  _bufferlayoututils.bool.call(void 0, "inverse")
]);
var ORACLE_LAYOUT = lo3.struct([
  lo3.seq(ORACLE_ELEMENT_LAYOUT, 4, "elements"),
  lo3.blob(4, "padding"),
  _bufferlayoututils.u64.call(void 0, "n"),
  lo3.blob(8 * 8)
]);
var PAIR_LAYOUT = lo3.struct([
  lo3.blob(8, "sighash"),
  _bufferlayoututils.publicKey.call(void 0, "controller"),
  lo3.seq(_bufferlayoututils.publicKey.call(void 0, "mint"), 2, "mints"),
  lo3.blob(8),
  lo3.seq(ORACLE_LAYOUT, 5, "oracles"),
  _bufferlayoututils.u64.call(void 0, "nOracle"),
  lo3.u8("A"),
  lo3.seq(lo3.u8(), 2, "feeRates"),
  lo3.blob(5),
  _bufferlayoututils.u64.call(void 0, "maxDelay"),
  _bufferlayoututils.u64.call(void 0, "confidence"),
  _bufferlayoututils.publicKey.call(void 0, "balancer"),
  lo3.u16("excessiveConfiscateRate"),
  _bufferlayoututils.publicKey.call(void 0, "feeCollector"),
  lo3.seq(lo3.u16(), 2, "platformFeeRate"),
  lo3.blob(18),
  lo3.seq(_bufferlayoututils.u128.call(void 0, "volumes"), 2, "volumes"),
  lo3.blob(80),
  _bufferlayoututils.bool.call(void 0, "enableRebalanceSwap"),
...
var SSL_LAYOUT = lo4.struct([
  ...
  lo4.u8("bump"),
  lo4.u8("ptBump"),
  _bufferlayoututils.bool.call(void 0, "suspended"),
  _bufferlayoututils.publicKey.call(void 0, "cranker"),
  lo4.blob(4),
  _bufferlayoututils.u64.call(void 0, "weight"),
  lo4.blob(8),
  _bufferlayoututils.u64.call(void 0, "swappedLiabilityNative"),
  _bufferlayoututils.u64.call(void 0, "totalShare"),
...
var STAKING_ACCOUNT_LAYOUT = lo5.struct([
  ...
  lo5.blob(7),
  _bufferlayoututils.u64.call(void 0, "share"),
  _bufferlayoututils.u64.call(void 0, "amountStaked"),
...
var ADDRESSES = {
  MAINNET: {
    CONTROLLER_PROGRAM_ID: new (0, _web3js.PublicKey)("8KJx48PYGHVC9fxzRRtYp4x4CM2HyYCm2EjVuAP4vvrx"),
    SSL_PROGRAM_ID: new (0, _web3js.PublicKey)("7WduLbRfYhTJktjLw5FDEyrqoEv61aTTCuGAetgLjzN5"),
    GFX_CONTROLLER: new (0, _web3js.PublicKey)("8CxKnuJeoeQXFwiG6XiGY2akBjvJA5k3bE52BfnuEmNQ")
  },
  DEVNET: {
    CONTROLLER_PROGRAM_ID: new (0, _web3js.PublicKey)("3Gwyhoudx8XgYry8dzKQ2GGsofkUdm7VZUvddHxchL3x"),
    SSL_PROGRAM_ID: new (0, _web3js.PublicKey)("JYe7AcuQ7CqhkGvchJGvSKF8ei41FuDKb1h47qkbFNf"),
    GFX_CONTROLLER: new (0, _web3js.PublicKey)("ApkmzBaTPUAeVj3QuqDcz6iLE6xZSLd29nke4McqrKw5")
  }
};
...
var SSL = class {
  ...
  static async liabilityVault(connection, controller, mint, otherMint, programId = ADDRESSES["MAINNET"].SSL_PROGRAM_ID) {
    ...
    let account = await _spltoken.getAccount.call(void 0, connection, address);
    return account;
  }
  ...
  async deposit(program, controller, wallet, amount, programId = ADDRESSES["MAINNET"].SSL_PROGRAM_ID) {
    ...
    return await inst.deposit(
      new (0, _anchor.BN)(amount.toString()),
      { accounts: accounts3 }
    );
  }
  ...
  constructor(controller = ADDRESSES["MAINNET"].GFX_CONTROLLER, programId = ADDRESSES["MAINNET"].SSL_PROGRAM_ID) {
    ...
    this.getPairAddress = (tokenA, tokenB) => {
      const addresses = [tokenA.toBuffer(), tokenB.toBuffer()].sort(
        _buffer.Buffer.compare
      );
      const pairArr = _web3js.PublicKey.findProgramAddressSync(
        [
          _buffer.Buffer.from("GFX-SSL-Pair", "utf-8"),
          this.controller.toBuffer(),
          addresses[0],
          addresses[1]
        ],
...
var Swap = class extends SyncSwap {
  constructor(connection, controller = ADDRESSES["MAINNET"].GFX_CONTROLLER, programId = ADDRESSES["MAINNET"].SSL_PROGRAM_ID) {
    ...
    this.createAssociatedTokenAccountIx = (mint, associatedAccount, owner) => _spltoken.createAssociatedTokenAccountInstruction.call(void 0, 
      owner,
      associatedAccount,
      owner,
      mint
    ...
    this.createSwapIx = async (tokenA, tokenB, inTokenAmount, minOut, wallet, referrerTokenAccount) => {
      let ixs = [];
      const addedComputeBudgetIX = _web3js.ComputeBudgetProgram.requestUnits({
        units: 1e6,
        additionalFee: 0
      });
      ...
      const program = new (0, _anchor.Program)(
        ...
        new (0, _anchor.Provider)(this.connection, wallet, {
      ...
      if (tokenB.toBase58() !== _spltoken.NATIVE_MINT.toBase58() && !(await this.connection.getParsedAccountInfo(tokenAccountB)).value) {
        ixs.push(
      ...
      ixs.push(
        await inst.swap(
          new (0, _anchor.BN)(inTokenAmount.toString()),
          new (0, _anchor.BN)(minOut.toString()),
...
var loadWasm = async () => {
  await gfx_ssl_wasm_default(_buffer.Buffer.from(gfx_ssl_wasm_data_default, "base64"));
  wasmInited = true;
};
...
var Quoter = class extends SyncQuoter {
  ...
  async prepare() {
    ...
    const liabilityVaultIn = await _spltoken.getAccount.call(void 0, 
      this.connection,
      findAssociatedTokenAddress(sslIn, this.tokenIn)
    );
    const swappedLiabilityVaultIn = await _spltoken.getAccount.call(void 0, 
      this.connection,
      findAssociatedTokenAddress(sslIn, this.tokenOut)
    );
    const liabilityVaultOut = await _spltoken.getAccount.call(void 0, 
      this.connection,
      findAssociatedTokenAddress(sslOut, this.tokenOut)
    );
    const swappedLiabilityVaultOut = await _spltoken.getAccount.call(void 0, 
      this.connection,
    ...
    for (const oracle of oracles.slice(0, n)) {
      ...
      for (const elem of oracle.elements.slice(0, n2)) {
        ...
        if (acctInfo == null ? void 0 : acctInfo.data) {
          ...
          publishedSlots.push(_client.parsePriceData.call(void 0, acctInfo.data).aggregate.publishSlot);
        }
      }
    }
    this.prepared = {
...
exports.ADDRESSES = ADDRESSES; exports.CONTROLLER_IDL = gfx_controller_idl_exports; exports.CONTROLLER_LAYOUT = CONTROLLER_LAYOUT; exports.LIQUIDITY_ACCOUNT_LAYOUT = LIQUIDITY_ACCOUNT_LAYOUT; exports.ORACLE_ELEMENT_LAYOUT = ORACLE_ELEMENT_LAYOUT; exports.ORACLE_LAYOUT = ORACLE_LAYOUT; exports.PAIR_LAYOUT = PAIR_LAYOUT; exports.SSL = SSL; exports.SSL_IDL = gfx_ssl_idl_exports; exports.SSL_LAYOUT = SSL_LAYOUT; exports.STAKING_ACCOUNT_LAYOUT = STAKING_ACCOUNT_LAYOUT; exports.Swap = Swap; exports.SyncSwap = SyncSwap; exports.loadWasm = loadWasm; exports.wasm = gfx_ssl_wasm_exports;
