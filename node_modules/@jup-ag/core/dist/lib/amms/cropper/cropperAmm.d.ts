...
import { CropperPoolState } from '@jup-ag/core/dist/lib/amms/cropper/swapLayout';
...
export declare class CropperAmm implements Amm {
    ...
    private feePct;
    private params;
    static getStateFromStateAccount(connection: Connection): Promise<import("@jup-ag/core/dist/lib/amms/cropper/swapLayout").CropperState>;
