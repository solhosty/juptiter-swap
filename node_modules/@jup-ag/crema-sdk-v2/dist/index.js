...
var _anchor = require('@project-serum/anchor'); var anchor = _interopRequireWildcard(_anchor);

var _web3js = require('@solana/web3.js');
var CLMMPOOLS_CONFIG = new (0, _web3js.PublicKey)(
  "2LecshUwdy9xi7meFgHtFJQNSKk4KdTrcpvaB56dP2NQ"
);
var CLMMPOOL_PROGRAM_ID = new (0, _web3js.PublicKey)(
  "CLMM9tUoggJu2wagPkkqs9eFG4BWhVBZWkP1qv3Sp7tR"
);
var MINT_WRAPPER_PROGRAM_ID = new (0, _web3js.PublicKey)(
...
var PROTOCOL_FEE_RATE_DENOMINATOR = new (0, _anchor.BN)(1e4);
var FEE_RATE_DENOMINATOR = new (0, _anchor.BN)(1e6);
var TICK_ARRAY_MAP_MAX_BIT_INDEX = 868 * 8 - 1;
var TICK_ARRAY_MAP_MIN_BIT_INDEX = 0;
var MAX_TICK_ARRAY = 3;
var TICK_ARRAY_AMOUNT = 6943;
var POSITION_NFT_UPDATE_AUTHORITY = new (0, _web3js.PublicKey)(
...
var _pubkey = require('@project-serum/anchor/dist/cjs/utils/pubkey');
...
var U128 = TWO.pow(new (0, _bnjs2.default)(128));
var U64_MAX = TWO.pow(new (0, _bnjs2.default)(64)).sub(ONE);
var U128_MAX = TWO.pow(new (0, _bnjs2.default)(128)).sub(ONE);
var MathUtil = class {
  static toX64_BN(num) {
    return num.mul(new (0, _bnjs2.default)(2).pow(new (0, _bnjs2.default)(64)));
  }
  static toX64_Decimal(num) {
    return num.mul(decimal_default.pow(2, 64));
  }
  static toX64(num) {
    return new (0, _bnjs2.default)(num.mul(decimal_default.pow(2, 64)).floor().toFixed());
  }
  static fromX64(num) {
  ...
  static fromX64_BN(num) {
    return num.div(new (0, _bnjs2.default)(2).pow(new (0, _bnjs2.default)(64)));
  }
  ...
  static divRoundUp(n0, n1) {
    ...
    if (hasRemainder) {
      return n0.div(n1).add(new (0, _bnjs2.default)(1));
    } else {
      return n0.div(n1);
    }
  }
  ...
  static isOverflow(n, bit) {
    return n.gte(TWO.pow(new (0, _bnjs2.default)(bit)));
  }
};
...
function tickIndexToSqrtPricePositive(tick) {
  ...
  if ((tick & 2) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("79236085330515764027303304731")),
      96,
      256
    );
  }
  if ((tick & 4) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("79244008939048815603706035061")),
      96,
      256
    );
  }
  if ((tick & 8) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("79259858533276714757314932305")),
      96,
      256
    );
  }
  if ((tick & 16) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("79291567232598584799939703904")),
      96,
      256
    );
  }
  if ((tick & 32) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("79355022692464371645785046466")),
      96,
      256
    );
  }
  if ((tick & 64) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("79482085999252804386437311141")),
      96,
      256
    );
  }
  if ((tick & 128) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("79736823300114093921829183326")),
      96,
      256
    );
  }
  if ((tick & 256) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("80248749790819932309965073892")),
      96,
      256
    );
  }
  if ((tick & 512) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("81282483887344747381513967011")),
      96,
      256
    );
  }
  if ((tick & 1024) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("83390072131320151908154831281")),
      96,
      256
    );
  }
  if ((tick & 2048) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("87770609709833776024991924138")),
      96,
      256
    );
  }
  if ((tick & 4096) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("97234110755111693312479820773")),
      96,
      256
    );
  }
  if ((tick & 8192) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("119332217159966728226237229890")),
      96,
      256
    );
  }
  if ((tick & 16384) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("179736315981702064433883588727")),
      96,
      256
    );
  }
  if ((tick & 32768) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("407748233172238350107850275304")),
      96,
      256
    );
  }
  if ((tick & 65536) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("2098478828474011932436660412517")),
      96,
      256
    );
  }
  if ((tick & 131072) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("55581415166113811149459800483533")),
      96,
      256
    );
  }
  if ((tick & 262144) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("38992368544603139932233054999993551")),
      96,
      256
    );
  }
...
function tickIndexToSqrtPriceNegative(tickIndex) {
  ...
  let ratio;
  if ((tick & 1) !== 0) {
    ratio = new (0, _anchor.BN)("18445821805675392311");
  } else {
    ratio = new (0, _anchor.BN)("18446744073709551616");
  }
  if ((tick & 2) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("18444899583751176498")),
      64,
      256
    );
  }
  if ((tick & 4) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("18443055278223354162")),
      64,
      256
    );
  }
  if ((tick & 8) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("18439367220385604838")),
      64,
      256
    );
  }
  if ((tick & 16) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("18431993317065449817")),
      64,
      256
    );
  }
  if ((tick & 32) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("18417254355718160513")),
      64,
      256
    );
  }
  if ((tick & 64) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("18387811781193591352")),
      64,
      256
    );
  }
  if ((tick & 128) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("18329067761203520168")),
      64,
      256
    );
  }
  if ((tick & 256) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("18212142134806087854")),
      64,
      256
    );
  }
  if ((tick & 512) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("17980523815641551639")),
      64,
      256
    );
  }
  if ((tick & 1024) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("17526086738831147013")),
      64,
      256
    );
  }
  if ((tick & 2048) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("16651378430235024244")),
      64,
      256
    );
  }
  if ((tick & 4096) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("15030750278693429944")),
      64,
      256
    );
  }
  if ((tick & 8192) !== 0) {
    ratio = signedShiftRight(
      ratio.mul(new (0, _anchor.BN)("12247334978882834399")),
      64,
      256
    );
  }
  if ((tick & 16384) !== 0) {
    ratio = signedShiftRight(ratio.mul(new (0, _anchor.BN)("8131365268884726200")), 64, 256);
  }
  if ((tick & 32768) !== 0) {
    ratio = signedShiftRight(ratio.mul(new (0, _anchor.BN)("3584323654723342297")), 64, 256);
  }
  if ((tick & 65536) !== 0) {
    ratio = signedShiftRight(ratio.mul(new (0, _anchor.BN)("696457651847595233")), 64, 256);
  }
  if ((tick & 131072) !== 0) {
    ratio = signedShiftRight(ratio.mul(new (0, _anchor.BN)("26294789957452057")), 64, 256);
  }
  if ((tick & 262144) !== 0) {
    ratio = signedShiftRight(ratio.mul(new (0, _anchor.BN)("37481735321082")), 64, 256);
  }
  return ratio;
}
...
var AddressUtil = class {
  static toPubKey(address) {
    return _anchor.translateAddress.call(void 0, address);
  }
  ...
  static findProgramAddress(seeds, programId) {
    const [publicKey, bump] = _anchor.utils.publicKey.findProgramAddressSync(
      seeds,
      programId
    );
...
var TickUtil = class {
  ...
  static checkIsValidTick(tick_index, tick_spacing) {
    ...
    _tinyinvariant2.default.call(void 0, tick_index >= min && tick_index <= max, `tick index invalid`);
    _tinyinvariant2.default.call(void 0, tick_index % tick_spacing === 0, `tick index invalid`);
  }
  ...
  static crossUpdate(tick, pool, aToB) {
    ...
    const signedLiquidityChange = aToB ? tick.liquidityNet.mul(new (0, _bnjs.BN)(-1)) : tick.liquidityNet;
  ...
  static getClmmpoolPDA(programId, clmmConfigKey, tokenMintAKey, tokenMintBKey, tickSpacing) {
    ...
    return AddressUtil.findProgramAddress(
      [
        ...
        mintA.toBuffer(),
        mintB.toBuffer(),
        new (0, _bnjs2.default)(tickSpacing).toArrayLike(Buffer, "le", 2)
      ],
      programId
    );
  }
  ...
  static getTickArrayPDA(programId, clmmpoolKey, arrayIndex) {
    return AddressUtil.findProgramAddress(
      [
        ...
        new (0, _bnjs2.default)(arrayIndex).toArrayLike(Buffer, "le", 2)
      ],
      programId
    );
  }
...
var SwapUtils = class {
  static getDefaultSqrtPriceLimit(a2b) {
    return new (0, _bnjs2.default)(a2b ? MIN_SQRT_PRICE : MAX_SQRT_PRICE);
  }
...
function getDeltaA(sqrtPrice0, sqrtPrice1, liquidity, roundUp) {
  ...
  const result = roundUp && !remainder.eq(ZERO) ? quotient.add(new (0, _bnjs2.default)(1)) : quotient;
...
function getNextSqrtPriceAUp(sqrtPrice, liquidity, amount, byAmountIn) {
  ...
  if (nextSqrtPrice.lt(new (0, _bnjs2.default)(MIN_SQRT_PRICE))) {
    throw new ClmmpoolsError(
      "getNextSqrtPriceAUp - Next sqrt price less than min sqrt price",
      "TokenAmountMinSubceeded " /* TokenAmountMinSubceeded */
    );
  }
  if (nextSqrtPrice.gt(new (0, _bnjs2.default)(MAX_SQRT_PRICE))) {
    throw new ClmmpoolsError(
...
function getNextSqrtPriceBDown(sqrtPrice, liquidity, amount, byAmountIn) {
  ...
  if (nextSqrtPrice.lt(new (0, _bnjs2.default)(MIN_SQRT_PRICE)) || nextSqrtPrice.gt(new (0, _bnjs2.default)(MAX_SQRT_PRICE))) {
    throw new ClmmpoolsError(
...
function computeSwap(aToB, byAmountIn, amount, poolData, swapTicks, clmmpool2, tickArrayMap) {
  ...
  for (const tick of swapTicks) {
    ...
    const stepResult = computeSwapStep(
      ...
      currentLiquidity,
      remainerAmount,
      new (0, _bnjs2.default)(poolData.feeRate),
      byAmountIn
    );
    ...
    if (stepResult.nextSqrtPrice.eq(tick.sqrtPrice)) {
      signedLiquidityChange = aToB ? tick.liquidityNet.mul(new (0, _bnjs2.default)(-1)) : tick.liquidityNet;
...
exports.AccountName = AccountName; exports.CLMMPOOLS_CONFIG = CLMMPOOLS_CONFIG; exports.CLMMPOOL_PROGRAM_ID = CLMMPOOL_PROGRAM_ID; exports.FEE_RATE_DENOMINATOR = FEE_RATE_DENOMINATOR; exports.IDL = IDL; exports.MAX_SQRT_PRICE = MAX_SQRT_PRICE; exports.MAX_TICK_ARRAY = MAX_TICK_ARRAY; exports.MAX_TICK_INDEX = MAX_TICK_INDEX; exports.METADATA_PROGRAM_ADDRESS = METADATA_PROGRAM_ADDRESS; exports.MINT_WRAPPER_PROGRAM_ID = MINT_WRAPPER_PROGRAM_ID; exports.MIN_SQRT_PRICE = MIN_SQRT_PRICE; exports.MIN_TICK_INDEX = MIN_TICK_INDEX; exports.PDAUtil = PDAUtil; exports.POSITION_NFT_UPDATE_AUTHORITY = POSITION_NFT_UPDATE_AUTHORITY; exports.PROTOCOL_FEE_RATE_DENOMINATOR = PROTOCOL_FEE_RATE_DENOMINATOR; exports.TICK_ARRAY_AMOUNT = TICK_ARRAY_AMOUNT; exports.TICK_ARRAY_MAP_MAX_BIT_INDEX = TICK_ARRAY_MAP_MAX_BIT_INDEX; exports.TICK_ARRAY_MAP_MIN_BIT_INDEX = TICK_ARRAY_MAP_MIN_BIT_INDEX; exports.TICK_ARRAY_SIZE = TICK_ARRAY_SIZE; exports.TickMath = TickMath; exports.TickUtil = TickUtil; exports.ZERO_BN = ZERO_BN; exports.computeSwap = computeSwap;
