...
var sdkCore = require('@cykura/sdk-core');
...
var _TICK_SPACINGS;
var FACTORY_ADDRESS = /*#__PURE__*/new anchor.web3.PublicKey('cysPXAjehMpVKUapzbMCCnpFxUFFryEWEaLgnb9NrR8');
...
var TICK_SPACINGS = (_TICK_SPACINGS = {}, _TICK_SPACINGS[exports.FeeAmount.SUPER_STABLE] = 1, _TICK_SPACINGS[exports.FeeAmount.TURBO_SPL] = 60, _TICK_SPACINGS[exports.FeeAmount.LOW] = 10, _TICK_SPACINGS[exports.FeeAmount.MEDIUM] = 60, _TICK_SPACINGS[exports.FeeAmount.HIGH] = 200, _TICK_SPACINGS);
...
function computePoolAddress(_ref) {
  ...
  var token0Key = new anchor.web3.PublicKey(token0.address);
  var token1Key = new anchor.web3.PublicKey(token1.address);
  return anchor.web3.PublicKey.findProgramAddress([POOL_SEED, token0Key.toBuffer(), token1Key.toBuffer(), u32ToSeed(fee)], factoryAddress).then(function (_ref3) {
...
var FullMath = /*#__PURE__*/function () {
  ...
  FullMath.mulDivFloor = function mulDivFloor(a, b, denominator) {
    !JSBI.notEqual(denominator, ZERO) ?  invariant(false, 'DIVISION_BY_0')  : void 0;
    var product = JSBI.multiply(a, b);
...
var SqrtPriceMath = /*#__PURE__*/function () {
  ...
  SqrtPriceMath.getAmount0Delta = function getAmount0Delta(sqrtRatioAX32, sqrtRatioBX32, liquidity, roundUp) {
    ...
    !JSBI.greaterThan(sqrtRatioAX32, ZERO) ?  invariant(false, 'SQRTA32_GT_0')  : void 0;
...
var TickMath = /*#__PURE__*/function () {
  ...
  TickMath.getTickAtSqrtRatio = function getTickAtSqrtRatio(sqrtRatioX32) {
    ...
    var msb$1 = msb(new anchor.BN(sqrtRatioX32.toString()));
    var r;
...
var Pool = /*#__PURE__*/function () {
  ...
  function Pool(tokenA, tokenB, fee, sqrtRatioX32, liquidity, tickCurrent, tickDataProvider) {
    ...
    !(JSBI.greaterThanOrEqual(sqrtRatioX32, tickCurrentSqrtRatioX32) && JSBI.lessThanOrEqual(sqrtRatioX32, nextTickSqrtRatioX32)) ?  invariant(false, 'PRICE_BOUNDS')  : void 0;
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount, sqrtPriceLimitX32) {
    ...
    return [sdkCore.CurrencyAmount.fromRawAmount(outputToken, JSBI.multiply(outputAmount, NEGATIVE_ONE)), new Pool(this.token0, this.token1, this.fee, sqrtRatioX32, liquidity, tickCurrent, this.tickDataProvider), accounts];
  }
  /**
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount, sqrtPriceLimitX32) {
    ...
    return [sdkCore.CurrencyAmount.fromRawAmount(inputToken, inputAmount), new Pool(this.token0, this.token1, this.fee, sqrtRatioX32, liquidity, tickCurrent, this.tickDataProvider)];
  }
  /**
   * Simulate a swap
  ...
  _proto.swap = function swap(zeroForOne, amountSpecified, sqrtPriceLimitX32) {
    !JSBI.notEqual(amountSpecified, ZERO) ?  invariant(false, 'AMOUNT_LESS_THAN_0')  : void 0;
...
function transformObservation(_ref) {
  ...
  return _extends({}, observation, {
    ...
    secondsPerLiquidityCumulativeX32: observation.secondsPerLiquidityCumulativeX32.add(delta.shln(32).div(liquidity.gtn(0) ? liquidity : new anchor.BN(1))),
    initialized: true
  });
}
...
exports.snapshotCumulativesInside = snapshotCumulativesInside;
exports.tickPosition = tickPosition;
exports.tickToPrice = tickToPrice;
exports.toHex = toHex;
exports.tradeComparator = tradeComparator;
exports.transformObservation = transformObservation;
exports.u16ToSeed = u16ToSeed;
exports.u32ToSeed = u32ToSeed;
//# sourceMappingURL=cykura-sdk.cjs.development.js.map
