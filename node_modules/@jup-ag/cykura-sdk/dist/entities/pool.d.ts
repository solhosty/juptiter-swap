...
export declare class Pool {
    ...
    static getAddress(tokenA: Token, tokenB: Token, fee: FeeAmount): Promise<web3.PublicKey>;
    /**
     * Construct a pool
     ...
     */
    constructor(tokenA: Token, tokenB: Token, fee: FeeAmount, sqrtRatioX32: JSBI, liquidity: JSBI, tickCurrent: number, tickDataProvider?: TickDataProvider);
    /**
     ...
     */
    getOutputAmount(inputAmount: CurrencyAmount<Token>, sqrtPriceLimitX32?: JSBI): [CurrencyAmount<Token>, Pool, AccountMeta[]];
    /**
     ...
     */
    getInputAmount(outputAmount: CurrencyAmount<Token>, sqrtPriceLimitX32?: JSBI): [CurrencyAmount<Token>, Pool];
    /**
     * Simulate a swap
